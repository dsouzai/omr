...
public:
    ...
    VirtualMachineOperandArray(
        TR::MethodBuilder* mb, int32_t numOfElements, TR::IlType* elementType, TR::VirtualMachineRegister* arrayBase);
     ...
     * @param b builder object where the operations will be added to make the current operand array the same as the
     * other
     */
