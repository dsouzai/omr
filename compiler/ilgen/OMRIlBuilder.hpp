...
public:
    ...
    TR::IlValue *genCall(TR::SymbolReference *methodSymRef, int32_t numArgs, TR::IlValue **paramValues,
...
protected:
    ...
    void ifCmpCondition(TR_ComparisonTypes ct, bool isUnsignedCmp, TR::IlValue *left, TR::IlValue *right,
        TR::Block *target);
    ...
    void pullInBuilderTrees(TR::IlBuilder *builder, uint32_t *currentBlock, TR::TreeTop **firstTree,
    ...
    TR::IlValue *genOperationWithOverflowCHK(TR::ILOpCodes op, TR::Node *leftNode, TR::Node *rightNode,
    ...
    void generateSwitchCases(TR::Node *switchNode, TR::Node *defaultNode, TR::IlBuilder **defaultBuilder,
        uint32_t numCases, JBCase **cases);
};
