...
OMR::BytecodeBuilder::BytecodeBuilder(TR::MethodBuilder *methodBuilder, int32_t bcIndex, char *name, int32_t bcLength)
    ...
    , _vmState(0)
{
    ...
    initialize(methodBuilder->details(), methodBuilder->methodSymbol(), methodBuilder->fe(),
        methodBuilder->symRefTab());
    initSequence();
}

void TR::BytecodeBuilder::initialize(TR::IlGeneratorMethodDetails *details, TR::ResolvedMethodSymbol *methodSymbol,
...
void OMR::BytecodeBuilder::appendBlock(TR::Block *block, bool addEdge)
{
    if (block == NULL) {
        block = emptyBlock();
    }
...
uint32_t OMR::BytecodeBuilder::countBlocks()
{
...
bool OMR::BytecodeBuilder::connectTrees()
{
    if (!_connectedTrees) {
...
void OMR::BytecodeBuilder::addAllSuccessorBuildersToWorklist()
{
    if (NULL != _fallThroughBuilder)
...
void OMR::BytecodeBuilder::AddFallThroughBuilder(TR::BytecodeBuilder *ftb)
{
...
void OMR::BytecodeBuilder::AddSuccessorBuilders(uint32_t numExits, ...)
{
    va_list exits;
    ...
    for (auto e = 0U; e < numExits; e++) {
        ...
        if ((*builder)->_bcIndex
            < _bcIndex) // If the successor has a bcIndex < than the current bcIndex this may be a loop
...
void OMR::BytecodeBuilder::setHandlerInfo(uint32_t catchType)
{
    TR::Block *catchBlock = getEntry();
    catchBlock->setIsCold();
    catchBlock->setHandlerInfo(catchType, static_cast<uint8_t>(comp()->getInlineDepth()), -1,
        _methodSymbol->getResolvedMethod(), comp());
}

void OMR::BytecodeBuilder::propagateVMState(TR::VirtualMachineState *fromVMState)
{
...
void OMR::BytecodeBuilder::transferVMState(TR::BytecodeBuilder **b)
{
...
void OMR::BytecodeBuilder::Goto(TR::BytecodeBuilder **dest)
{
    if (*dest == NULL)
...
void OMR::BytecodeBuilder::IfCmpEqual(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpEqualZero(TR::BytecodeBuilder **dest, TR::IlValue *c)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpNotEqual(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpNotEqualZero(TR::BytecodeBuilder **dest, TR::IlValue *c)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpLessThan(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpUnsignedLessThan(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpLessOrEqual(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpUnsignedLessOrEqual(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpGreaterThan(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpUnsignedGreaterThan(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpGreaterOrEqual(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void OMR::BytecodeBuilder::IfCmpUnsignedGreaterOrEqual(TR::BytecodeBuilder **dest, TR::IlValue *v1, TR::IlValue *v2)
{
    if (*dest == NULL)
        *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void *OMR::BytecodeBuilder::client()
{
