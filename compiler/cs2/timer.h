...
public:
     ...
     */
    PhaseMeasuringSummary(const char *name = "Total elapsed metric", const Allocator &a = Allocator(),
        bool collect = true)
        : fNodes(a)
        , fNode(0)
        , fCollect(collect)
...
template<class Meter, class Allocator>
template<class ostream>
inline void PhaseMeasuringSummary<Meter, Allocator>::DumpSummaryNode(ostream &out, ListIndex root, uint32_t indent,
    Metric total, bool running, bool alternativeFormat, bool csv)
{
