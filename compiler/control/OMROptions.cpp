...
TR::OptionTable OMR::Options::_jitOptions[] = {
   ...
   {"disableFileBackedCodeCacheDisclaiming","O\tdisable disclaiming of file-backed code caches", RESET_OPTION_BIT(TR_EnableFileBackedCodeCacheDisclaiming), "F", NOT_IN_SUBSET},
   ...
   {"enableFileBackedCodeCacheDisclaiming","O\tenable disclaiming of file-backed code caches", SET_OPTION_BIT(TR_EnableFileBackedCodeCacheDisclaiming), "F", NOT_IN_SUBSET},
