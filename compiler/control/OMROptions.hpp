...
enum TR_CompilationOptions {
    ...
    TR_CountOptTransformations = 0x00800000, // Must be same option word as TR_TraceOptDetails to allow
    ...
    TR_UnresolvedAreNotColdAtCold
    = 0x00004000 + 4, // cold block marker marks unresolved blocks as cold at hotness cold or less
    ...
    TR_ReservingLocks
    = 0x00004000 + 6, // Can be merged with TR_DisableLockResevation when lock reservation is enabled on all platforms
    ...
    TR_DisableClearCodeCacheFullFlag = 0x00000200
        + 21, // Disable the re-enabling of the code cache when a method body is freed after the cache has become full
...
public:
    ...
    static TR::OptionSet* findOptionSet(
        TR_Memory*, int32_t index, int32_t lineNum, TR_ResolvedMethod*, TR_Hotness, bool);
    ...
    static const char* processOptions(
    ...
    static bool isAnyVerboseOptionSet(
...
public:
     ...
     */
    static const char* processOptionSetPostRestore(
...
private:
    ...
    static const char* processOption(
        const char* option, TR::OptionTable* table, void* base, int32_t numEntries, TR::OptionSet* optionSet);
...
private:
    ...
    static const char* setVerboseBitsHelper(
