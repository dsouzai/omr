...
TR_ResolvedMethod* TR_FrontEnd::createResolvedMethod(
    TR_Memory*, TR_OpaqueMethodBlock*, TR_ResolvedMethod*, TR_OpaqueClassBlock*)
{
    TR_UNIMPLEMENTED();
    return 0;
}
...
TR_OpaqueMethodBlock* TR_FrontEnd::getMethodFromName(
    const char* className, const char* methodName, const char* signature)
{
    TR_UNIMPLEMENTED();
    return 0;
}
...
TR_OpaqueClassBlock* TR_FrontEnd::getClassFromSignature(
    const char* sig, int32_t length, TR_ResolvedMethod* method, bool isVettedForAOT)
{
    TR_UNIMPLEMENTED();
    return 0;
}
...
TR_OpaqueClassBlock* TR_FrontEnd::getClassFromSignature(
    const char* sig, int32_t length, TR_OpaqueMethodBlock* method, bool isVettedForAOT)
{
    TR_UNIMPLEMENTED();
    return 0;
}
...
intptr_t TR_FrontEnd::getStringUTF8Length(uintptr_t objectPointer)
{
    TR_UNIMPLEMENTED();
    return -1;
}

char* TR_FrontEnd::getStringUTF8(uintptr_t objectPointer, char* buffer, intptr_t bufferSize)
{
    TR_UNIMPLEMENTED();
    return NULL;
}
