...
OMR::CompilerEnv::CompilerEnv(
    TR::RawAllocator raw, const TR::PersistentAllocatorKit& persistentAllocatorKit, OMRPortLibrary* const portLib)
    : rawAllocator(raw)
    , _initialized(false)
...
void OMR::CompilerEnv::initializeRelocatableTargetEnvironment()
{
