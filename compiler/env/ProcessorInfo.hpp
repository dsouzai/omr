...
{
    return TR_BuiltInFPU | TR_CMPXCHG8BInstruction | TR_CMOVInstructions | TR_MMXInstructions | TR_SSE | TR_SSE2;
}
...
{
    return TR_SSE3 | TR_SSSE3 | TR_SSE4_1 | TR_SSE4_2 | TR_POPCNT | TR_AESNI | TR_OSXSAVE | TR_AVX | TR_FMA;
}
...
{
    return TR_HLE | TR_RTM | TR_CLWB | TR_AVX2 | TR_AVX512F | TR_AVX512VL | TR_AVX512BW | TR_AVX512DQ | TR_AVX512CD;
}
...
inline uint32_t getFeatureFlags10Mask() { return TR_AVX512_VBMI2 | TR_AVX512_BITALG | TR_AVX512_VPOPCNTDQ; }
