...
TR_Debug* TR::FECommon::createDebug(TR::Compilation* comp) { return createDebugObject(comp); }
...
TR::OptionTable OMR::Options::_feOptions[]
    = { { "code=", "C<nnn>\tsize of a single code cache, in KB", TR::Options::set32BitNumericInJitConfig,
            offsetof(OMR::FrontEnd::JitConfig, options.codeCacheKB), 0, " %d (KB)" },
          ...
          { "limitfile=",
              ...
              TR::Options::limitfileOption, 0, 0, "P%s" },
