...
public:
    ...
    int32_t getOffset(bool withRegSym = false)
    {
        ...
        if (withRegSym && _symbolReference->getSymbol() != NULL
     ...
     */
    bool refsRegister(TR::Register* reg) { return reg == _baseRegister; }
     ...
     */
    bool isBaseModifiable() { return ((_flag & TR_RVMemoryReferenceControl_Base_Modifiable) != 0); }
    /**
