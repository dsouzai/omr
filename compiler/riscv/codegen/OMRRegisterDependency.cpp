...
void OMR::RV::RegisterDependencyConditions::addPostCondition(
...
void OMR::RV::RegisterDependencyConditions::assignPreConditionRegisters(
...
void OMR::RV::RegisterDependencyConditions::assignPostConditionRegisters(
    TR::Instruction* currentInstruction, TR_RegisterKinds kindToBeAssigned, TR::CodeGenerator* cg)
{
...
TR::RegisterDependencyConditions* OMR::RV::RegisterDependencyConditions::clone(
