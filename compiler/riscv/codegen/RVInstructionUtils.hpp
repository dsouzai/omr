...
static inline uint32_t TR_RISCV_RTYPE(
    TR::InstOpCode::Mnemonic insn, TR::Register* rd, TR::Register* rs1, TR::Register* rs2)
{
...
static inline uint32_t TR_RISCV_ITYPE(
    TR::InstOpCode::Mnemonic insn, TR::RealRegister::RegNum rd, TR::RealRegister::RegNum rs1, uint32_t imm)
{
...
static inline uint32_t TR_RISCV_STYPE(
    TR::InstOpCode::Mnemonic insn, TR::RealRegister::RegNum rs1, TR::RealRegister::RegNum rs2, uint32_t imm)
{
...
{
    return TR_RISCV_STYPE(
        insn, toRealRegister(rs1)->getRegisterNumber(), toRealRegister(rs2)->getRegisterNumber(), imm);
}
...
static inline uint32_t TR_RISCV_SBTYPE(
    TR::InstOpCode::Mnemonic insn, TR::RealRegister::RegNum rs1, TR::RealRegister::RegNum rs2, uint32_t imm)
{
...
static inline uint32_t TR_RISCV_SBTYPE(
    TR::InstOpCode::Mnemonic insn, TR::Register* rs1, TR::Register* rs2, uint32_t imm)
{
    return TR_RISCV_SBTYPE(
        insn, toRealRegister(rs1)->getRegisterNumber(), toRealRegister(rs2)->getRegisterNumber(), imm);
}
