...
OMR::RV::MemoryReference::MemoryReference(TR::Register* br, TR::CodeGenerator* cg)
    : _baseRegister(br)
    , _baseNode(NULL)
    , _unresolvedSnippet(NULL)
    , _flag(0)
...
OMR::RV::MemoryReference::MemoryReference(TR::Register* br, int32_t disp, TR::CodeGenerator* cg)
    : _baseRegister(br)
    , _baseNode(NULL)
    , _unresolvedSnippet(NULL)
    , _flag(0)
...
void OMR::RV::MemoryReference::setSymbol(TR::Symbol* symbol, TR::CodeGenerator* cg)
{
    ...
    if (_baseRegister != NULL && (self()->hasDelayedOffset() || self()->getOffset(true) != 0)) {
...
void OMR::RV::MemoryReference::consolidateRegisters(
