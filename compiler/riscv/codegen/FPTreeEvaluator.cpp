...
TR::Register* OMR::RV::TreeEvaluator::ibits2fEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register* OMR::RV::TreeEvaluator::fbits2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register* OMR::RV::TreeEvaluator::lbits2dEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register* OMR::RV::TreeEvaluator::dbits2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    TR::Register* trgReg = cg->allocateRegister();
...
TR::Register* OMR::RV::TreeEvaluator::fconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    TR::Register* trgReg = cg->allocateSinglePrecisionRegister();
...
TR::Register* OMR::RV::TreeEvaluator::dconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    TR::Register* trgReg = cg->allocateRegister(TR_FPR);
    TR::Register* tmpReg = cg->allocateRegister();
    TR::Register* zero = cg->machine()->getRealRegister(TR::RealRegister::zero);
...
TR::Register* OMR::RV::TreeEvaluator::dreturnEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
static TR::Register* commonFPtoINTconversionEvaluator(
...
static TR::Register* commonINTtoFPconversionEvaluator(
    TR::Node* node, TR::InstOpCode::Mnemonic op, TR::CodeGenerator* cg)
{
    TR::Node* firstChild = node->getFirstChild();
    TR::Register* src1Reg = cg->evaluate(firstChild);
...
static TR::Register* commonFPPtoFPconversionEvaluator(
    TR::Node* node, TR::InstOpCode::Mnemonic op, TR::CodeGenerator* cg)
{
    TR::Node* firstChild = node->getFirstChild();
    TR::Register* src1Reg = cg->evaluate(firstChild);
...
static TR::Register* compareHelper(TR::Node* node, TR::InstOpCode::Mnemonic op, bool reverse, TR::CodeGenerator* cg)
{
    TR::Node* firstChild = node->getFirstChild();
    TR::Register* src1Reg = cg->evaluate(firstChild);
    TR::Node* secondChild = node->getSecondChild();
...
static TR::Register* compareNotEqualHelper(TR::Node* node, TR::InstOpCode::Mnemonic op, TR::CodeGenerator* cg)
{
    TR::Node* firstChild = node->getFirstChild();
    TR::Register* src1Reg = cg->evaluate(firstChild);
    TR::Node* secondChild = node->getSecondChild();
...
static TR::Register* compareUnorderedHelper(
    TR::Node* node, TR::InstOpCode::Mnemonic cmpOp, bool reverse, TR::CodeGenerator* cg)
{
    TR::Node* firstChild = node->getFirstChild();
    TR::Register* src1Reg = cg->evaluate(firstChild);
    TR::Node* secondChild = node->getSecondChild();
...
static TR::Register* compareEqualOrUnorderedHelper(TR::Node* node, TR::CodeGenerator* cg)
{
    TR::Node* firstChild = node->getFirstChild();
    TR::Register* src1Reg = cg->evaluate(firstChild);
    TR::Node* secondChild = node->getSecondChild();
...
TR::Register* OMR::RV::TreeEvaluator::fRegLoadEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
static TR::Register* commonFpMinMaxEvaluator(
    TR::Node* node, TR::InstOpCode::Mnemonic cmpOp, bool reverse, bool isDouble, TR::CodeGenerator* cg)
{
...
TR::Register* OMR::RV::TreeEvaluator::fcmpequEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    return compareEqualOrUnorderedHelper(node, cg);
}

TR::Register* OMR::RV::TreeEvaluator::fcmpneuEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    /*
...
TR::Register* OMR::RV::TreeEvaluator::dcmpneuEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    /*
...
// also handles fcmpl
TR::Register* OMR::RV::TreeEvaluator::dcmplEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    return compareThreeWayHelper(node, true, cg);
}

// also handles fcmpg
TR::Register* OMR::RV::TreeEvaluator::dcmpgEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    return compareThreeWayHelper(node, false, cg);
}

static TR::Register* commonFpSelectEvaluator(TR::Node* node, bool isDouble, TR::CodeGenerator* cg)
{
...
TR::Register* OMR::RV::TreeEvaluator::fselectEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    return commonFpSelectEvaluator(node, false, cg);
}

TR::Register* OMR::RV::TreeEvaluator::dselectEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
