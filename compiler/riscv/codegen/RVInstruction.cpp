...
uint8_t* TR::LoadInstruction::generateBinaryEncoding()
{
    ...
    *iPtr = TR_RISCV_ITYPE(
        getOpCode().getMnemonic(), getTargetRegister(), getMemoryBase(), getMemoryReference()->getOffset(true));
...
uint8_t* TR::StoreInstruction::generateBinaryEncoding()
{
    ...
    *iPtr = TR_RISCV_STYPE(
        getOpCode().getMnemonic(), getMemoryBase(), getSource1Register(), getMemoryReference()->getOffset(true));
...
uint8_t* TR::BtypeInstruction::generateBinaryEncoding()
{
    ...
    *iPtr = TR_RISCV_SBTYPE(
        getOpCode().getMnemonic(), getSource1Register(), getSource2Register(), 0 /* to fix up in the future */);
