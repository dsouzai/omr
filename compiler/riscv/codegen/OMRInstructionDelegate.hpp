...
#ifndef OMR_RV_INSTRUCTIONDELEGATE_INCL
#define OMR_RV_INSTRUCTIONDELEGATE_INCL
...
namespace OMR {
 namespace RV { class InstructionDelegate; }
 typedef OMR::RV::InstructionDelegate InstructionDelegateConnector;
}
#else
