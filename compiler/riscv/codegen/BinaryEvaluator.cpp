 ...
 */
static TR::Register* RorIhelper(
    TR::Node* node, TR::InstOpCode::Mnemonic opr, TR::InstOpCode::Mnemonic opi, TR::CodeGenerator* cg)
{
    ...
    if (secondChild->getOpCode().isLoadConst() && secondChild->getRegister() == NULL) {
        ...
        if (value > 0 && cg->convertMultiplyToShift(node)) {
            ...
            if (value == 0) {
                ...
                trgReg = cg->allocateRegister();
                generateRTYPE(
                    is32bit ? TR::InstOpCode::_mulw : TR::InstOpCode::_mul, node, trgReg, src1Reg, src2Reg, cg);
            }
        }
    } else {
        TR::Register* src2Reg = cg->evaluate(secondChild);
    ...
    if (secondChild->getOpCode().isLoadConst()) {
        ...
        if (shamt != 0) {
            ...
            if (width < 32) {
                ...
                generateITYPE(
                    width == 64 ? TR::InstOpCode::_slli : TR::InstOpCode::_slliw, node, trgReg, src1Reg, shamt, cg);
            }
        } else {
        ...
        if (width < 32) {
            ...
            generateRTYPE(
                width == 64 ? TR::InstOpCode::_sll : TR::InstOpCode::_sllw, node, trgReg, src1Reg, src2Reg, cg);
        }
    }
...
TR::Register* OMR::RV::TreeEvaluator::ishrEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    if (secondChild->getOpCode().isLoadConst()) {
        ...
        if (shamt != 0) {
            ...
            generateITYPE(
                width == 64 ? TR::InstOpCode::_srai : TR::InstOpCode::_sraiw, node, trgReg, src1Reg, shamt, cg);
        } else {
            trgReg = cg->evaluate(firstChild);
        }
    } else {
        ...
        if (width < 32) {
            ...
            generateRTYPE(
                width == 64 ? TR::InstOpCode::_sra : TR::InstOpCode::_sraw, node, trgReg, src1Reg, src2Reg, cg);
        }
    }
    ...
    if (secondChild->getOpCode().isLoadConst()) {
        ...
        if (shamt != 0) {
            ...
            if (width < 32) {
                ...
                generateITYPE(
                    width == 64 ? TR::InstOpCode::_srli : TR::InstOpCode::_srliw, node, trgReg, src1Reg, shamt, cg);
            }
        } else {
            trgReg = cg->evaluate(firstChild);
        }
