...
public:
    RtypeInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
...
public:
    ItypeInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg, uint32_t imm,
        TR::CodeGenerator* cg)
...
public:
    LoadInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::MemoryReference* mr, TR::CodeGenerator* cg)
        : TR::Instruction(op, n, cg)
        , _target1Register(treg)
        , _memoryReference(mr)
    {
    ...
    LoadInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::MemoryReference* mr,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : TR::Instruction(op, n, precedingInstruction, cg)
        , _target1Register(treg)
        , _memoryReference(mr)
...
public:
    StypeInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* s1reg, TR::Register* s2reg, uint32_t imm,
        TR::CodeGenerator* cg)
        : TR::Instruction(op, n, cg)
        , _source1Register(s1reg)
        , _source2Register(s2reg)
...
public:
    StoreInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* n, TR::MemoryReference* mr, TR::Register* sreg, TR::CodeGenerator* cg)
        : TR::Instruction(op, n, cg)
    ...
    StoreInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::MemoryReference* mr, TR::Register* sreg,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : TR::Instruction(op, n, precedingInstruction, cg)
        , _source1Register(sreg)
        , _memoryReference(mr)
...
public:
    BtypeInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym, TR::Register* s1reg,
        TR::Register* s2reg, TR::CodeGenerator* cg)
...
public:
    UtypeInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm, TR::Register* treg, TR::CodeGenerator* cg)
        : TR::Instruction(op, n, cg)
        , _target1Register(treg)
        , _imm(imm)
    {
    ...
    UtypeInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm, TR::Register* treg,
        TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
        : TR::Instruction(op, n, cond, cg)
        , _target1Register(treg)
        , _imm(imm)
...
public:
    JtypeInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, uintptr_t imm,
    ...
    JtypeInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::LabelSymbol* label,
        TR::Snippet* snippet, TR::RegisterDependencyConditions* cond, TR::Instruction* precedingInstruction,
        TR::CodeGenerator* cg)
...
public:
     ...
     * @param[in] cg : CodeGenerator
     */
    AdminInstruction(TR::InstOpCode::Mnemonic op, TR::RegisterDependencyConditions* cond, TR::Node* node,
...
public:
     ...
     * @param[in] cg : CodeGenerator
     */
    DataInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, uint32_t imm, TR::Instruction* precedingInstruction,
        TR::CodeGenerator* cg)
        : TR::Instruction(op, node, precedingInstruction, cg)
        , _sourceImmediate(imm)
    {
...
public:
    VGNOPInstruction(TR::Node* node, TR_VirtualGuardSite* site, TR::RegisterDependencyConditions* cond,
