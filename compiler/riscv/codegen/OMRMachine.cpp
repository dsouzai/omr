...
TR::RealRegister* OMR::RV::Machine::freeBestRegister(
...
TR::RealRegister* OMR::RV::Machine::reverseSpillState(
...
TR::RealRegister* OMR::RV::Machine::assignOneRegister(
...
void OMR::RV::Machine::coerceRegisterAssignment(
