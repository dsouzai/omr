...
public:
    ...
    static TR::Register *vabsIntHelper(TR::Node *node, TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic shift,
    ...
    static TR::Register *dualMulHelper64(TR::Node *node, TR::Node *lmulNode, TR::Node *lumulhNode,
        TR::CodeGenerator *cg);
    static TR::Register *dualMulHelper32(TR::Node *node, TR::Node *lmulNode, TR::Node *lumulhNode,
        TR::CodeGenerator *cg);
    ...
    static TR::Instruction *generateNullTestInstructions(TR::CodeGenerator *cg, TR::Register *trgReg, TR::Node *node,
    ...
    static void preserveTOCRegister(TR::Node *node, TR::CodeGenerator *cg,
