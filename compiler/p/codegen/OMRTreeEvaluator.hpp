...
typedef OMR::Power::TreeEvaluator TreeEvaluatorConnector;
} // namespace OMR
#else
...
public:
    ...
    static TR::Register* vabsIntHelper(
    ...
    static TR::Register* dualMulHelper32(
        TR::Node* node, TR::Node* lmulNode, TR::Node* lumulhNode, TR::CodeGenerator* cg);
    ...
    static TR::Register* compareIntsForEquality(TR::InstOpCode::Mnemonic branchOp, TR::LabelSymbol* dstLabel,
        TR::Node* node, TR::CodeGenerator* cg, bool isHint = false, bool likeliness = false);
    static TR::Register* compareIntsForOrder(
        TR::InstOpCode::Mnemonic branchOp, TR::Node* node, TR::CodeGenerator* cg, bool isSigned);
    static TR::Register* compareIntsForOrder(TR::InstOpCode::Mnemonic branchOp, TR::LabelSymbol* dstLabel,
    ...
    static TR::Register* compareLongsForEquality(TR::InstOpCode::Mnemonic branchOp, TR::LabelSymbol* dstLabel,
        TR::Node* node, TR::CodeGenerator* cg, bool isHint = false, bool likeliness = false);
    static TR::Register* compareLongsForOrder(TR::InstOpCode::Mnemonic branchOp,
    ...
    static TR::Register* compareLongsForOrder(TR::InstOpCode::Mnemonic branchOp,
        ...
        bool isSigned, bool isHint = false, bool likeliness = false);
    ...
    static TR::Instruction* generateNullTestInstructions(
        TR::CodeGenerator* cg, TR::Register* trgReg, TR::Node* node, bool nullPtrSymRefRequired = false);

    // Common evaluator routines
    static void postSyncConditions(TR::Node* node, TR::CodeGenerator* cg, TR::Register* dataReg,
        TR::MemoryReference* memRef, TR::InstOpCode::Mnemonic syncOp, bool lazyVolatile = false);
    static TR::Register* performCall(TR::Node* node, bool isIndirect, TR::CodeGenerator* cg);

    // VM dependent routines

    static void preserveTOCRegister(
    ...
    static TR::Instruction* generateHelperBranchAndLinkInstruction(TR_RuntimeHelper helperIndex, TR::Node* node,
        TR::RegisterDependencyConditions* conditions, TR::CodeGenerator* cg);

private:
    static TR::Register* int2dbl(TR::Node* node, TR::Register* srcReg, bool canClobber, TR::CodeGenerator* cg);
