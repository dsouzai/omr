...
TR::RealRegister* OMR::Power::RealRegister::regMaskToRealRegister(
    TR_RegisterMask mask, TR_RegisterKinds rk, TR::CodeGenerator* cg)
{
    RegNum rr;
...
TR_RegisterMask OMR::Power::RealRegister::getAvailableRegistersMask(TR_RegisterKinds rk)
{
    if (rk == TR_GPR)
...
void OMR::Power::RealRegister::setRegisterFieldRT(uint32_t* instruction)
{
...
void OMR::Power::RealRegister::setRegisterFieldRA(uint32_t* instruction)
{
    if (self()->isConditionRegister())
...
void OMR::Power::RealRegister::setRegisterFieldRB(uint32_t* instruction)
{
    if (self()->isConditionRegister())
...
void OMR::Power::RealRegister::setRegisterFieldRC(uint32_t* instruction)
{
    if (self()->isConditionRegister())
        *instruction |= fullRegBinaryEncodings[_registerNumber] << (pos_RC + 2);
    else
        *instruction |= fullRegBinaryEncodings[_registerNumber] << pos_RC;
}
void OMR::Power::RealRegister::setRegisterFieldXS(uint32_t* instruction)
{
...
void OMR::Power::RealRegister::setRegisterFieldXT(uint32_t* instruction)
{
...
void OMR::Power::RealRegister::setRegisterFieldXA(uint32_t* instruction)
{
...
void OMR::Power::RealRegister::setRegisterFieldXB(uint32_t* instruction)
{
...
void OMR::Power::RealRegister::setRegisterFieldXC(uint32_t* instruction)
{
