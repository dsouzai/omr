...
class PPCAlignmentNopInstruction : public TR::Instruction {
    ...
    {
        TR_ASSERT_FATAL(
            (alignment % PPC_INSTRUCTION_LENGTH) == 0, "Alignment must be a multiple of the nop instruction length");
...
public:
    ...
    PPCAlignmentNopInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t alignment,
...
public:
    ...
    PPCImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm, TR::Instruction* precedingInstruction,
    ...
    PPCImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm,
        TR_ExternalRelocationTargetKind relocationKind, TR::CodeGenerator* cg, uint32_t bf = 0)
        : TR::Instruction(op, n, cg)
        , _sourceImmediate(imm)
    ...
    PPCImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm,
        TR_ExternalRelocationTargetKind relocationKind, TR::SymbolReference* sr, TR::CodeGenerator* cg, uint32_t bf = 0)
        : TR::Instruction(op, n, cg)
        , _sourceImmediate(imm)
        , _reloKind(relocationKind)
        , _symbolReference(sr)
...
public:
    PPCImm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm, uint32_t imm2, TR::CodeGenerator* cg)
        : PPCImmInstruction(op, n, imm, cg)
        , _sourceImmediate2(imm2)
    { }
...
public:
    PPCSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* sreg, uint32_t imm,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : PPCImmInstruction(op, n, imm, precedingInstruction, cg)
    ...
    PPCSrc1Instruction(
        TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* sreg, uint32_t imm, TR::CodeGenerator* cg)
        : PPCImmInstruction(op, n, imm, cg)
        , _source1Register(sreg)
    {
        useRegister(sreg);
...
public:
    PPCDepInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* n, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
        : TR::Instruction(op, n, cg)
        , _conditions(cond)
    {
    ...
    PPCDepInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::RegisterDependencyConditions* cond,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : TR::Instruction(op, n, precedingInstruction, cg)
        , _conditions(cond)
    {
...
public:
    PPCDepLabelInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym,
        TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
        : PPCLabelInstruction(op, n, sym, cg)
        , _conditions(cond)
    {
        cond->bookKeepingRegisterUses(this, cg);
    }
    ...
    virtual TR::Register* getTargetRegister(uint32_t i) { return _conditions->getTargetRegister(i, cg()); }

    virtual TR::Register* getSourceRegister(uint32_t i) { return _conditions->getSourceRegister(i); }
...
public:
    PPCConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym, TR::Register* cr,
        TR::CodeGenerator* cg, bool likeliness)
        : PPCLabelInstruction(op, n, sym, cg)
        , _conditionRegister(cr)
    ...
    PPCConditionalBranchInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym, TR::Register* cr, TR::CodeGenerator* cg)
        : PPCLabelInstruction(op, n, sym, cg)
        , _conditionRegister(cr)
        , _estimatedBinaryLocation(0)
        , _farRelocation(false)
...
public:
    PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym, TR::Register* cr,
        TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg, bool likeliness)
        : PPCConditionalBranchInstruction(op, n, sym, cr, cg, likeliness)
        , _conditions(cond)
    {
        cond->bookKeepingRegisterUses(this, cg);
    }
    ...
    PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym, TR::Register* cr,
        TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
        : PPCConditionalBranchInstruction(op, n, sym, cr, cg)
        , _conditions(cond)
    {
        cond->bookKeepingRegisterUses(this, cg);
    }
...
public:
    PPCDepImmSymInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uintptr_t imm,
        TR::RegisterDependencyConditions* cond, TR::SymbolReference* sr, TR::Snippet* s, TR::CodeGenerator* cg)
        : PPCDepInstruction(op, n, cond, cg)
        , _addrImmediate(imm)
        , _symbolReference(sr)
        , _snippet(s)
    { }
...
public:
    PPCTrg1ImmInstruction(
        ...
        : PPCTrg1Instruction(op, n, treg, cg)
        , _sourceImmediate(imm) {};

    PPCTrg1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, uint32_t imm,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : PPCTrg1Instruction(op, n, treg, precedingInstruction, cg)
        , _sourceImmediate(imm) {};
...
public:
    ...
    PPCSrc2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* s1reg, TR::Register* s2reg,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg);
...
public:
    PPCSrc3Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* s1reg, TR::Register* s2reg,
        TR::Register* s3reg, TR::CodeGenerator* cg)
        : TR::PPCSrc2Instruction(op, n, s1reg, s2reg, cg)
    ...
    PPCSrc3Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* s1reg, TR::Register* s2reg,
        TR::Register* s3reg, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : TR::PPCSrc2Instruction(op, n, s1reg, s2reg, precedingInstruction, cg)
        , _source3Register(s3reg)
    {
        useRegister(s3reg);
    }
...
public:
    ...
    PPCTrg1Src1Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg);
...
public:
    PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        uintptr_t imm, TR::CodeGenerator* cg)
        : PPCTrg1Src1Instruction(op, n, treg, sreg, cg)
        , _source1Immediate(imm) {};

    PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        uintptr_t imm, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : PPCTrg1Src1Instruction(op, n, treg, sreg, precedingInstruction, cg)
        , _source1Immediate(imm) {};

    PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        TR::Register* cr0reg, uintptr_t imm, TR::CodeGenerator* cg)
        : PPCTrg1Src1Instruction(op, n, treg, sreg, cg)
        , _source1Immediate(imm)
    {
    ...
    PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        TR::Register* cr0reg, uintptr_t imm, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : PPCTrg1Src1Instruction(op, n, treg, sreg, precedingInstruction, cg)
        , _source1Immediate(imm)
    {
        TR::RegisterDependencyConditions* cond
...
public:
    PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        uint32_t imm, uint64_t m, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, imm, precedingInstruction, cg)
        , _mask(m)
    { }

    PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        uint32_t imm, uint64_t m, TR::CodeGenerator* cg)
        : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, imm, cg)
        , _mask(m)
    { }

    PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        TR::Register* cr0reg, uint32_t imm, uint64_t m, TR::CodeGenerator* cg)
        : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, cr0reg, imm, cg)
        , _mask(m)
    { }

    PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        TR::Register* cr0reg, uint32_t imm, uint64_t m, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
...
public:
    PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
        TR::Register* s2reg, TR::CodeGenerator* cg)
        : PPCTrg1Src1Instruction(op, n, treg, s1reg, cg)
    ...
    PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
        TR::Register* s2reg, TR::Register* cr0reg, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : PPCTrg1Src1Instruction(op, n, treg, s1reg, precedingInstruction, cg)
        , _source2Register(s2reg)
    {
        useRegister(s2reg);
...
public:
    PPCTrg1Src2ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
        TR::Register* s2reg, int64_t m, TR::CodeGenerator* cg)
        : PPCTrg1Src2Instruction(op, n, treg, s1reg, s2reg, cg)
        , _mask(m)
    { }

    PPCTrg1Src2ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
        TR::Register* s2reg, int64_t m, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
...
public:
    PPCTrg1Src3Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
    ...
    virtual TR::Register* getSourceRegister(uint32_t i)
    {
        if (i == 0)
            ...
            return getSource2Register();
        else if (i == 2)
            return _source3Register;
        return NULL;
    }
...
public:
    PPCMemInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::MemoryReference* mf, TR::CodeGenerator* cg);

    PPCMemInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::MemoryReference* mf,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg);
    ...
    virtual TR::Register* getSourceRegister(uint32_t i)
    {
        switch (i) {
        case 0:
            return (_memoryReference->getBaseRegister() == NULL) ? _memoryReference->getIndexRegister()
                                                                 : _memoryReference->getBaseRegister();
        case 1:
            return _memoryReference->getIndexRegister();
        default:
            return NULL;
        }
    }
...
public:
    PPCMemSrc1Instruction(
        TR::InstOpCode::Mnemonic op, TR::Node* n, TR::MemoryReference* mf, TR::Register* sreg, TR::CodeGenerator* cg);

    PPCMemSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::MemoryReference* mf, TR::Register* sreg,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg);
...
public:
    PPCTrg1MemInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::MemoryReference* mf,
    ...
    virtual TR::Register* getTargetRegister() { return PPCTrg1Instruction::getTargetRegister(); }
...
public:
    PPCControlFlowInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::CodeGenerator* cg,
        TR::RegisterDependencyConditions* deps = NULL, bool useRegPairForResult = false, bool useRegPairForCond = false)
        : TR::Instruction(op, n, cg)
        , _numSources(0)
        , _numTargets(0)
        , _label(NULL)
        ...
        , _conditions(deps)
        , _useRegPairForResult(useRegPairForResult)
        , _useRegPairForCond(useRegPairForCond)
    {
        if (deps != NULL)
            deps->bookKeepingRegisterUses(this, cg);
    }
    PPCControlFlowInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Instruction* preceedingInstruction,
        TR::CodeGenerator* cg, TR::RegisterDependencyConditions* deps = NULL, bool useRegPairForResult = false,
    ...
    virtual TR::Register* getSourceRegister(uint32_t i)
    {
        if (i >= _numSources || _isSourceImmediate[i])
            return NULL;
        return _sources[i]._sourceRegister;
    }
    TR::Register* setSourceRegister(uint32_t i, TR::Register* sr)
    {
    ...
    virtual uint32_t getSourceImmediate(uint32_t i)
    {
        if (i >= _numSources || !_isSourceImmediate[i])
            return 0;
        return _sources[i]._sourceImmediate;
    }
    void setSourceImmediate(uint32_t i, uint32_t val)
    {
...
public:
    PPCVirtualGuardNOPInstruction(TR::Node* node, TR_VirtualGuardSite* site, TR::RegisterDependencyConditions* cond,
        TR::LabelSymbol* label, TR::CodeGenerator* cg)
        : PPCDepLabelInstruction(TR::InstOpCode::vgnop, node, label, cond, cg)
        , _site(site)
    { }

    PPCVirtualGuardNOPInstruction(TR::Node* node, TR_VirtualGuardSite* site, TR::RegisterDependencyConditions* cond,
        TR::LabelSymbol* label, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : PPCDepLabelInstruction(TR::InstOpCode::vgnop, node, label, cond, precedingInstruction, cg)
        , _site(site)
    { }
