...
protected:
    ...
    MemoryReference(TR::LabelSymbol* label, int64_t disp, uint8_t len, TR::CodeGenerator* cg);
...
public:
    ...
    TR::PPCPairedRelocation* setStaticRelocation(TR::PPCPairedRelocation* r) { return (_staticRelocation = r); }
