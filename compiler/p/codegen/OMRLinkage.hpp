...
struct PPCLinkageProperties {
    ...
    uint32_t getReserved(TR::RealRegister::RegNum regNum) const { return (_registerFlags[regNum] & PPC_Reserved); }
    ...
    // for 32-bit use only
    TR::RealRegister::RegNum getLongLowReturnRegister() const { return _returnRegisters[1]; }

    // for 32-bit use only
    TR::RealRegister::RegNum getLongHighReturnRegister() const { return _returnRegisters[0]; }

    // for 64-bit use only
    TR::RealRegister::RegNum getLongReturnRegister() const { return _returnRegisters[0]; }
    ...
    TR::RealRegister::RegNum getVectorReturnRegister() const { return _returnRegisters[_firstVectorReturnRegister]; }
    ...
    int32_t getNumAllocatableVectorRegisters() const { return _numAllocatableVectorRegisters; }
    ...
    TR::RealRegister::RegNum getNormalStackPointerRegister() const { return _normalStackPointerRegister; }

    TR::RealRegister::RegNum getAlternateStackPointerRegister() const { return _alternateStackPointerRegister; }

    TR::RealRegister::RegNum getTOCBaseRegister() const { return _TOCBaseRegister; }
...
public:
    ...
    virtual TR::Instruction* saveArguments(
