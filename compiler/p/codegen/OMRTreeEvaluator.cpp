...
TR::Register *OMR::Power::TreeEvaluator::setmemoryEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    generateMemSrc1Instruction(cg, TR::InstOpCode::stw, node,
        TR::MemoryReference::createWithDisplacement(cg, dstAddrReg, 0, 4), valueReg);
    ...
    generateMemSrc1Instruction(cg, TR::InstOpCode::sth, node,
        TR::MemoryReference::createWithDisplacement(cg, dstAddrReg, 0, 2), valueReg);
    ...
    generateMemSrc1Instruction(cg, TR::InstOpCode::stb, node,
        TR::MemoryReference::createWithDisplacement(cg, dstAddrReg, 0, 1), valueReg);
