...
TR_FilterBST *TR_Debug::addFilter(const char *&filterString, int32_t scanningExclude, int32_t optionSetIndex,
    int32_t lineNum, bool loadLimit)
{
    if (loadLimit) {
        // initializing filters using the new interface
 ...
 */
const char *TR_Debug::inlinefileOption(const char *option, void *base, TR::OptionTable *entry,
...
bool TR_Debug::methodSigCanBeFound(const char *methodSig, TR::CompilationFilters *filters, TR_FilterBST *&filter,
...
bool TR_Debug::methodCanBeFound(TR_Memory *trMemory, TR_ResolvedMethod *method, TR::CompilationFilters *filters,
    TR_FilterBST *&filter)
{
...
bool TR_Debug::methodSigCanBeCompiledOrRelocated(const char *methodSig, TR_FilterBST *&filter, bool loadLimit,
    TR::Method::Type methodType)
{
