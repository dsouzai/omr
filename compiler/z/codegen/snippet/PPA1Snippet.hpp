 ...
 *  0x00
 * +----------------------------------+----------------------------------+----------------------------------+----------------------------------+
 *       | Version                          | Signature                        | Saved GPR Mask | 0x04
 * +----------------------------------+----------------------------------+----------------------------------+----------------------------------+
 *       | Signed offset to PPA2 from start of PPA1 | 0x08
 * +----------------------------------+----------------------------------+----------------------------------+----------------------------------+
 *       | Flags 1                          | Flags 2                          | Flags 3                          |
 * Flags 4                          | |                                  |                                  | | | | 0
 * DSA format                    | 0  External function             | 0  State variable locator        | 0  Reserved |
 *       | 1  Reserved                      | 1  Debug info                    | 1  Argument area length          | 1
 * Reserved                      | | 2  Exception model               | 2  Debug info                    | 2  FPR mask
 * | 2  Reserved                      | | 3  BDI type flag                 | 3  Reserved                      | 3  AR
 * mask                       | 3  Reserved                      | | 4  Invoke for DSA exit           | 4  Reserved | 4
 * Member PPA1 word              | 4  Reserved                      | | 5  Reserved                      | 5  Reserved
 * | 5  Block debug info              | 5  Reserved                      | | 6  Reserved                      | 6
 * Reserved                      | 6  Interface mapping flags       | 6  Reserved                      | | 7  Vararg
 * function               | 7  Reserved                      | 7  Java method locator table     | 7  Name length and
 * name          | 0x0C
 * +----------------------------------+----------------------------------+----------------------------------+----------------------------------+
 *       | Length/4 of parameters                                              | Length/2 of prologue             |
 * Alloca register                  | |                                                                     | | Offset/2
 * to stack pointer update | 0x10
 * +----------------------------------+----------------------------------+----------------------------------+----------------------------------+
 ...
 *                                         0x01                               0x02                               0x03
 *  0x00 +----------------------------------+----------------------------------+
 *       | Length of name                                                      | PPA1 Flags 4 bit 7 0x02
 * +----------------------------------+----------------------------------+----------------------------------+----------------------------------+
