...
public:
    ...
    RegisterDependencyConditions(
        RegisterDependencyConditions* iConds, uint16_t numNewPreConds, uint16_t numNewPostConds, TR::CodeGenerator* cg)
        : OMR::RegisterDependencyConditionsConnector(iConds, numNewPreConds, numNewPostConds, cg)
    { }

    RegisterDependencyConditions(
        RegisterDependencyConditions* conds_1, RegisterDependencyConditions* conds_2, TR::CodeGenerator* cg)
