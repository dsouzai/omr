...
inline TR::InstOpCode::S390BranchCondition getBranchConditionForMask(uint32_t branchMask)
{
    switch (branchMask) {
    case 0:
        return TR::InstOpCode::COND_MASK0;
    case 1:
        return TR::InstOpCode::COND_MASK1;
    case 2:
        return TR::InstOpCode::COND_MASK2;
    case 3:
        return TR::InstOpCode::COND_MASK3;
    case 4:
        return TR::InstOpCode::COND_MASK4;
    case 5:
        return TR::InstOpCode::COND_MASK5;
    case 6:
        return TR::InstOpCode::COND_MASK6;
    case 7:
        return TR::InstOpCode::COND_MASK7;
    case 8:
        return TR::InstOpCode::COND_MASK8;
    case 9:
        return TR::InstOpCode::COND_MASK9;
    case 10:
        return TR::InstOpCode::COND_MASK10;
    case 11:
        return TR::InstOpCode::COND_MASK11;
    case 12:
        return TR::InstOpCode::COND_MASK12;
    case 13:
        return TR::InstOpCode::COND_MASK13;
    case 14:
        return TR::InstOpCode::COND_MASK14;
    case 15:
        return TR::InstOpCode::COND_MASK15;
    default:
...
inline uint8_t getReverseBranchMask(uint8_t m)
{
    switch (m) {
    case 0x2:
        return 0x4;
...
inline uint8_t getMaskForBranchCondition(TR::InstOpCode::S390BranchCondition branchCond)
{
    ...
    case TR::InstOpCode::COND_BRM:
        return 0x04;
    case TR::InstOpCode::COND_MASK5:
        return 0x05;
 ...
 */
inline TR::InstOpCode::S390BranchCondition getReverseBranchCondition(TR::InstOpCode::S390BranchCondition bc)
{
    switch (bc) {
    case TR::InstOpCode::COND_BNH:
    ...
    default: {
        ...
        if (mask == newMask)
            ...
            return getBranchConditionForMask(newMask);
    }
    }
}
