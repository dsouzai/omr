...
public:
    ...
    static TR::Register *dualMulHelper64(TR::Node *node, TR::Node *lmulNode, TR::Node *lumulhNode,
        TR::CodeGenerator *cg);
     ...
     *
     */
    static TR::Register *tryToReplaceShiftLandWithRotateInstruction(TR::Node *node, TR::CodeGenerator *cg,
    ...
    static TR::Register *floorCeilEvaluator(TR::Node *node, TR::CodeGenerator *cg,
        TR::InstOpCode::Mnemonic regToRegOpCode, int8_t mask);
    ...
    static void checkAndSetMemRefDataSnippetRelocationType(TR::Node *node, TR::CodeGenerator *cg,
        TR::MemoryReference *tempMR);

    static TR::Node *DAAAddressPointer(TR::Node *callNode, TR::CodeGenerator *cg);

    static void createDAACondDeps(TR::Node *node, TR::RegisterDependencyConditions *daaDeps, TR::Instruction *daaInstr,
        TR::CodeGenerator *cg);
     ...
     *     The number of bytes to copy.
     */
    static void primitiveArraycopyEvaluator(TR::Node *node, TR::CodeGenerator *cg, TR::Node *byteSrcNode,
    ...
    static TR::Register *evaluateLengthMinusOneForMemoryCmp(TR::Node *node, TR::CodeGenerator *cg, bool clobberEvaluate,
        bool &lenMinusOne);
    ...
    static TR::Register *arraytranslateEncodeSIMDEvaluator(TR::Node *node, TR::CodeGenerator *cg,
        ArrayTranslateFlavor convType);
    static TR::Register *arraytranslateDecodeSIMDEvaluator(TR::Node *node, TR::CodeGenerator *cg,
        ArrayTranslateFlavor convType);
    ...
    static TR::Register *inlineIfButestEvaluator(TR::Node *node, TR::CodeGenerator *cg, TR::Node *cmpOpNode,
        TR::Node *cmpValNode);
    static TR::Register *inlineIfBifEvaluator(TR::Node *ifNode, TR::CodeGenerator *cg, TR::Node *cmpOpNode,
        TR::Node *cmpValNode);
    ...
    static TR::Register *z990PopCountHelper(TR::Node *node, TR::CodeGenerator *cg, TR::Register *inReg,
        TR::Register *outReg);

    static TR::Register *getConditionCodeOrFold(TR::Node *node, TR::CodeGenerator *cg, TR_FoldType foldType,
        TR::Node *parent);
    static TR::Register *getConditionCodeOrFoldIf(TR::Node *node, TR::CodeGenerator *cg, bool isFoldedIf,
        TR::Node *ificmpNode);
