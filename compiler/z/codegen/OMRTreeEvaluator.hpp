...
enum ArrayTranslateFlavor { CharToByte, ByteToChar, ByteToByte, CharToChar };

enum TR_FoldType { TR_FoldNone, TR_FoldIf, TR_FoldLookup, TR_FoldNoIPM };
...
public:
    ...
    static TR::Register* dualMulHelper64(
     ...
     *
     *   \param isSignedShift
     *      If replacing a signed shift+and combination, this variable evaluates to true. Else it will evaluate to
     * false. Note: If we are using this function to replace a standalone 'and', then this variable should be false.
     *
     *   \return
     ...
     *
     */
    static TR::Register* tryToReplaceShiftLandWithRotateInstruction(
    ...
    static TR::Register* floorCeilEvaluator(
    ...
    static TR::InstOpCode::S390BranchCondition mapBranchConditionToLOCRCondition(
    ...
    static void tableEvaluatorCaseLabelHelper(TR::Node* node, TR::CodeGenerator* cg, tableKind tableKindToBeEvaluated,
        int32_t numBranchTableEntries, TR::Register* selectorReg, TR::Register* branchTableReg, TR::Register* reg1);
    ...
    static TR::Register* checkAndAllocateReferenceRegister(TR::Node* node, TR::CodeGenerator* cg, bool& dynLitPoolLoad);
    static void checkAndSetMemRefDataSnippetRelocationType(
    ...
    static void createDAACondDeps(
        TR::Node* node, TR::RegisterDependencyConditions* daaDeps, TR::Instruction* daaInstr, TR::CodeGenerator* cg);
    static void addToRegDep(TR::RegisterDependencyConditions* daaDeps, TR::Register* reg, bool mightUseRegPair);
     ...
     *     The number of bytes to copy.
     */
    static void primitiveArraycopyEvaluator(
    ...
    static void genLoopForwardArrayCopy(TR::Node* node, TR::CodeGenerator* cg, TR::Register* byteSrcReg,
        TR::Register* byteDstReg, TR::Register* loopIterReg, bool isConstantLength = false);
     ...
     *
     */
    static TR::RegisterDependencyConditions* generateMemToMemElementCopy(TR::Node* node, TR::CodeGenerator* cg,
        TR::Register* byteSrcReg, TR::Register* byteDstReg, TR::Register* byteLenReg,
        TR_S390ScratchRegisterManager* srm, bool isForward, bool needsGuardedLoad, bool genStartICFLabel = false,
    ...
    static TR::Register* evaluateLengthMinusOneForMemoryCmp(
    ...
    static TR::Register* arraycmpHelper(TR::Node* node, TR::CodeGenerator* cg, bool isWideChar, bool isEqualCmp = false,
        int32_t cmpValue = 0, TR::LabelSymbol* compareTarget = NULL, TR::Node* ificmpNode = NULL,
        bool needResultReg = true, bool return102 = false, TR::InstOpCode::S390BranchCondition* returnCond = NULL);
    static TR::Register* arraycmpSIMDHelper(TR::Node* node, TR::CodeGenerator* cg,
        TR::LabelSymbol* compareTarget = NULL, TR::Node* ificmpNode = NULL, bool needResultReg = true,
        bool return102 = false, bool isArrayCmpLen = false);

    static TR::Register* arraytranslateEvaluator(TR::Node* node, TR::CodeGenerator* cg);
    static TR::Register* arraytranslateEncodeSIMDEvaluator(
        TR::Node* node, TR::CodeGenerator* cg, ArrayTranslateFlavor convType);
    static TR::Register* arraytranslateDecodeSIMDEvaluator(
        TR::Node* node, TR::CodeGenerator* cg, ArrayTranslateFlavor convType);
    ...
    static TR::Register* inlineIfButestEvaluator(
        TR::Node* node, TR::CodeGenerator* cg, TR::Node* cmpOpNode, TR::Node* cmpValNode);
    static TR::Register* inlineIfBifEvaluator(
