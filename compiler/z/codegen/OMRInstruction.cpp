...
OMR::Z::Instruction::Instruction(TR::CodeGenerator *cg, TR::Instruction *precedingInstruction,
...
void OMR::Z::Instruction::initialize(TR::Instruction *precedingInstruction, bool instFlag,
    TR::RegisterDependencyConditions *cond, bool condFlag)
{
...
void OMR::Z::Instruction::assignOrderedRegisters(TR_RegisterKinds kindToBeAssigned)
{
    ...
    if (numTrgtPairs == 0 && _targetReg && _targetRegSize == 1 && _targetMem == NULL
        ...
        blockTarget = true;
        self()->block(_sourceReg, _sourceRegSize, _targetReg, _targetRegSize, self()->sourceMemBase(),
            self()->targetMemBase());
    }
