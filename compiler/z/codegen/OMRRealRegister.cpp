...
OMR::Z::RealRegister::RealRegister(
    TR_RegisterKinds rk, uint16_t w, RegState s, RegNum rn, RegMask m, TR::CodeGenerator* cg)
...
void OMR::Z::RealRegister::setRegister4Field(uint32_t* instruction, RegNum reg)
{
    ...
    TR::RealRegister::setRegisterField(
        instruction + 1, 7, reg); // the 4th reg field is in the 1st 4-bit of the 3rd halfword of the instuction
