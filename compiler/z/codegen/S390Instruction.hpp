...
public:
    ...
    S390VirtualGuardNOPInstruction(TR::Node *node, TR_VirtualGuardSite *site, TR::RegisterDependencyConditions *cond,
        ...
        : S390BranchInstruction(TR::InstOpCode::BRC, TR::InstOpCode::COND_VGNOP, node, label, cond,
              precedingInstruction, cg)
        , _site(site)
    {}
...
public:
    S390DebugCounterBumpInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Snippet *counterSnip,
        TR::CodeGenerator *cg, int32_t delta)
...
public:
    ...
    S390RegInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Instruction *precedingInstruction,
        TR::CodeGenerator *cg)
        : TR::Instruction(op, n, precedingInstruction, cg)
        , _branchCondition(TR::InstOpCode::COND_NOP)
        , _firstConstant(-1)
...
public:
    ...
    S390RIInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Instruction *precedingInstruction,
        TR::CodeGenerator *cg)
...
public:
    ...
    S390RREInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg, TR::Instruction *preced,
        TR::CodeGenerator *cg)
...
public:
    S390MemInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::MemoryReference *mf, TR::CodeGenerator *cg,
        bool use = true)
        : TR::Instruction(op, n, cg)
        , _memAccessMode(-1)
        , _constantField(-1)
...
public:
    ...
    S390AlignmentNopInstruction(TR::Node *n, uint32_t alignment, TR::Instruction *precedingInstruction,
        TR::CodeGenerator *cg)
...
public:
    ...
    S390OpCodeOnlyInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Instruction *precedingInstruction,
        TR::CodeGenerator *cg)
        : TR::Instruction(op, n, precedingInstruction, cg)
    {}
