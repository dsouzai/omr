...
public:
    ...
    virtual void setParameterLinkageRegisterIndex(
    ...
    virtual void initParamOffset(
        TR::ResolvedMethodSymbol* method, int32_t stackIndex, List<TR::ParameterSymbol>* parameterList = 0);
