...
public:
    ...
    TR::Instruction* markAndAdjustForLongDisplacementIfNeeded(
        TR::Node* node, TR::CodeGenerator* cg, TR::Instruction* preced, bool* testLongDisp = NULL);
...
TR::MemoryReference* generateS390MemoryReference(
    TR::Register*, int32_t, TR::CodeGenerator* cg, const char* name = NULL);
...
TR::MemoryReference* generateS390MemoryReference(
    int32_t, TR::DataType, TR::CodeGenerator*, TR::Register*, TR::Node* node = NULL);
TR::MemoryReference* generateS390MemoryReference(
    int64_t, TR::DataType, TR::CodeGenerator*, TR::Register*, TR::Node* node = NULL);
...
TR::MemoryReference* generateS390MemoryReference(
    TR::CodeGenerator* cg, TR::Node*, TR::Node*, int32_t disp = 0, bool forSS = false);
...
TR::MemoryReference* generateS390RightAlignedMemoryReference(
    TR::MemoryReference& baseMR, TR::Node* node, int32_t offset, TR::CodeGenerator* cg, bool enforceSSLimits = true);
