...
struct RegisterDependency : OMR::RegisterDependency {
    ...
    bool isEvenOddPair()
    {
        return _realRegister == static_cast<TR::RealRegister::RegNum>(TR::RealRegister::EvenOddPair);
    }
     ...
     */
    bool isLegalEvenOfPair()
    {
        return _realRegister == static_cast<TR::RealRegister::RegNum>(TR::RealRegister::LegalEvenOfPair);
    }
     ...
     */
    bool isLegalOddOfPair()
    {
        return _realRegister == static_cast<TR::RealRegister::RegNum>(TR::RealRegister::LegalOddOfPair);
    }
     ...
     */
    bool isLegalFirstOfFPPair()
    {
        return _realRegister == static_cast<TR::RealRegister::RegNum>(TR::RealRegister::LegalFirstOfFPPair);
    }
     ...
     *         register of a FP register pair; \c false otherwise.
     */
    bool isLegalSecondOfFPPair()
    {
        return _realRegister == static_cast<TR::RealRegister::RegNum>(TR::RealRegister::LegalSecondOfFPPair);
    }
     ...
     */
    bool isKillVolHighRegs()
    {
        return _realRegister == static_cast<TR::RealRegister::RegNum>(TR::RealRegister::KillVolHighRegs);
    }
