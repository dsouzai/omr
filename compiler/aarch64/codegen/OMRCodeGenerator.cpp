...
TR::ARM64ConstantDataSnippet* OMR::ARM64::CodeGenerator::findOrCreateConstantDataSnippet(
    TR::Node* node, void* c, size_t s)
{
...
TR::Instruction* OMR::ARM64::CodeGenerator::generateSwitchToInterpreterPrePrologue(
...
TR_GlobalRegisterNumber OMR::ARM64::CodeGenerator::getLinkageGlobalRegisterNumber(
...
bool OMR::ARM64::CodeGenerator::getSupportsOpCodeForAutoSIMD(TR::CPU* cpu, TR::ILOpCode opcode)
{
    ...
    case TR::m2s:
         ...
         * Since we are dealing with 128-bit vector, the type of elements of the mask with 2 lanes are either 64-bit
         * integer or double.
         */
...
void OMR::ARM64::CodeGenerator::setRealRegisterAssociation(
    TR::Register* virtualRegister, TR::RealRegister::RegNum realNum)
{
...
TR::Instruction* OMR::ARM64::CodeGenerator::generateDebugCounterBump(
    TR::Instruction* cursor, TR::DebugCounterBase* counter, int32_t delta, TR::RegisterDependencyConditions* cond)
{
    ...
    cursor = loadAddressConstant(
        self(), self()->comp()->compileRelocatableCode(), node, addr, addrReg, cursor, TR_DebugCounter);
