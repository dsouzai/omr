 ...
 */
static TR::Instruction* tryToGenerateImm16ShiftedInstrucion(
    TR::Node* node, TR::CodeGenerator* cg, TR::Register* treg, TR::InstOpCode::Mnemonic op, uint16_t value)
{
    if ((value & 0xff00) == 0) {
 ...
 * @return instruction cursor if an instruction is successfully generated and otherwise returns NULL
 */
static TR::Instruction* tryToGenerateImm32ShiftedInstruction(
    TR::Node* node, TR::CodeGenerator* cg, TR::Register* treg, TR::InstOpCode::Mnemonic op, uint32_t value)
{
 ...
 * @return instruction cursor if an instruction is successfully generated and otherwise returns NULL
 */
static TR::Instruction* tryToGenerateImm32ShiftingOnesInstruction(
    TR::Node* node, TR::CodeGenerator* cg, TR::Register* treg, TR::InstOpCode::Mnemonic op, uint32_t value)
{
 ...
 * @return instruction cursor if an instruction is successfully generated and otherwise returns NULL
 */
static TR::Instruction* tryToGenerateImm64Instruction(
    TR::Node* node, TR::CodeGenerator* cg, TR::Register* treg, TR::InstOpCode::Mnemonic op, uint64_t value)
{
 ...
 * @return instruction cursor if an instruction is successfully generated and otherwise returns NULL
 */
static TR::Instruction* tryToGenerateMovImm16ShiftedInstruction(
    TR::Node* node, TR::CodeGenerator* cg, TR::Register* treg, uint16_t value)
{
 ...
 * @return instruction cursor if an instruction is successfully generated and otherwise returns NULL
 */
static TR::Instruction* tryToGenerateMovImm32ShiftedInstruction(
    TR::Node* node, TR::CodeGenerator* cg, TR::Register* treg, uint32_t value)
{
...
TR::Register* OMR::ARM64::TreeEvaluator::mFirstTrueEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    case TR::Double:
         ...
         * umov    w0, v1.4s[3]                ; Byte 2-3 has the mask value of the lane 0. Byte 0-1 has the value of
         * the lane 1. clz     w0, w0                      ; Counts leading zeros. lsr     w0, w0, #4                  ;
         * Divides by 16.
         */
...
TR::Register* OMR::ARM64::TreeEvaluator::mToLongBitsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    case TR::Int8:
         ...
         * sli     v1.16b, v1.16b, #6          ; Shifts left v1 by 6 bits and inserts into v1. bit 6 - 9 of the lane 0,
         * 1, 2 and 3 have mask values. ushr    v1.8h, v1.8h, #6            ; Moves mask values to bit 0 - 3 of each
         * lane. sli     v1.8h, v1.8h, #12           ; Shifts left v1 by 12 bits and inserts into v1. bit 12 - 19 of the
         * lane 0 and 1 have mask values. umov    x0, v1.2d[0]                ; Mask values at bit 12 - 19 and bit 44
         * - 51. bfi     x0, x0, #24, #20            ; Inserts bit 0 - 19 into bit 24 - 43. ubfx    x0, x0, #36, #16 ;
         * Moves bit 36 - 51 to bit 0 - 15. Other bits are cleared.
         */
    ...
    case TR::Int16:
         ...
         * sli     v1.8h, v1.8h, #14           ; Shifts left v1 by 14 bits and inserts into v1. bit 14 - 17 of the lane
         * 0 and 1 have mask values. umov    w0, v1.2d[0] bfi     x0, x0, #28, #18            ; Inserts bit 0 - 17 into
         * bit 28 - 45. ubfx    x0, x0, #42, #8             ; Moves bit 42 - 49 to bit 0 - 7.
         */
...
TR::Register* OMR::ARM64::TreeEvaluator::mLongBitsToMaskEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    case TR::Int8:
        /*
         * fmov    d0, x0
         * sli     v0.2d, v0.2d, #24           ; Shifts left v0 by 24 bits and inserts into v0. bit 0 - 7 of the lane 0
         * and 1 in int32x4 vector have mask values. sli     v0.4s, v0.4s, #12           ; Shifts left v0 by 12 bits and
         * inserts into v0. bit 0 - 3 of the lane 0 - 3 in int16x8 vector have mask values. sli     v0.8h, v0.8h, #6 ;
         * Shifts left v0 by 6 bits and inserts into v0. bit 0 - 1 of the lane 0 - 7 in int8x16 vector have mask values.
    ...
    case TR::Int16:
        /*
         * fmov    d0, x0
         * sli     v0.2d, v0.2d, #28           ; Shifts left v0 by 28 bits and inserts into v0. bit 0 - 3 of the lane 0
         * and 1 in int32x4 vector have mask values. sli     v0.4s, v0.4s, #14           ; Shifts left v0 by 14 bits and
         * inserts into v0. bit 0 - 1 of the lane 0 - 3 in int16x8 vector have mask values. sli     v0.8h, v0.8h, #7 ;
         * Shifts left v0 by 7 bits and inserts into v0. The lsb of the lane 0 - 7 in int8x16 vector has mask values.
         * movi    v1.8h, #1
    ...
    case TR::Float:
        /*
         * fmov    d0, x0
         * sli     v0.2d, v0.2d, #30           ; Shifts left v0 by 30 bits and inserts into v0. bit 0 - 1 of the lane 0
         * and 1 in int32x4 vector have mask values. sli     v0.4s, v0.4s, #15           ; Shifts left v0 by 15 bits and
         * inserts into v0. The lsb of the lane 0 - 3 in int16x8 vector have mask values. movi    v1.4s, #1 uxtl v0.4s,
         * v0.4h                ; The lsb of each lane in int32x4 vector has mask values. cmtst   v0.4s, v0.4s, v1.4s ;
         * test if bit 0 of each lane is set
         */
        generateTrg1Src1Instruction(cg, TR::InstOpCode::fmov_xtod, node, maskReg, srcReg);
    ...
    case TR::Double:
        /*
         * ubfiz   x1, x0, #55, #2             ; Copies 2 bits from the lsb of x0 into the bit 55 of x1. Other bits of
         * x1 are cleared. fmov    d0, x1 ext     v0.16b, v0.16b, v0.16b, #15 ; Moves 8bits elements to the left. bit 63
         * and 64 have mask values. cmeq    v0.2d, v0.2d, #0 not     v0.16b, v0.16b
         */
...
// vector evaluators
TR::Instruction* OMR::ARM64::TreeEvaluator::vsplatsImmediateHelper(
    TR::Node* node, TR::CodeGenerator* cg, TR::Node* firstChild, TR::DataType elementType, TR::Register* treg)
{
...
static TR::Register* vcmpHelper(
    TR::Node* node, VectorCompareOps compareOp, bool omitNot, bool* flipCompareResult, TR::CodeGenerator* cg);
    ...
    if (isMasked) {
        ...
        if (notAfterCompare) {
            ...
            generateTrg1Src2Instruction(
                cg, flipMask ? TR::InstOpCode::vbic16b : TR::InstOpCode::vand16b, node, targetReg, targetReg, maskReg);
        }
...
typedef TR::Register* (*reductionEvaluatorHelper)(
    TR::Node* node, TR::DataType et, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg);
/**
 ...
 */
static TR::Register* vreductionAddFloatHelper(
    TR::Node* node, TR::DataType et, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
    if (et == TR::Float) {
...
TR::Register* OMR::ARM64::TreeEvaluator::vreductionAddEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    default:
        TR_ASSERT_FATAL_WITH_NODE(
            node, false, "unrecognized vector type %s", node->getFirstChild()->getDataType().toString());
        return NULL;
    }
 ...
 * @return general purpose register containing the result
 */
static TR::Register* vreductionAndHelper(
    TR::Node* node, TR::DataType et, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
...
TR::Register* OMR::ARM64::TreeEvaluator::vreductionAndEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    case TR::Double:
        TR_ASSERT_FATAL_WITH_NODE(
            node, false, "Unexpected element type %s", node->getFirstChild()->getDataType().toString());
        return NULL;
    default:
        TR_ASSERT_FATAL_WITH_NODE(
            node, false, "unrecognized vector type %s", node->getFirstChild()->getDataType().toString());
 ...
 */
static TR::Register* vreductionMinMaxInt64Helper(
    TR::Node* node, bool isMax, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
    ...
    generateCondTrg1Src2Instruction(
        cg, TR::InstOpCode::cselx, node, resReg, tmpReg, resReg, isMax ? TR::CC_GT : TR::CC_LT);
 ...
 * @return register containing the result
 */
static TR::Register* vreductionMaxInt64Helper(
    TR::Node* node, TR::DataType et, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
 ...
 * @return register containing the result
 */
static TR::Register* vreductionMinInt64Helper(
    TR::Node* node, TR::DataType et, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
 ...
 * @return general purpose register containing the result
 */
static TR::Register* vreductionMulInt64Helper(
    TR::Node* node, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
 ...
 * @return general purpose register containing the result
 */
static TR::Register* vreductionMulFloatingPointHelper(
    TR::Node* node, TR::DataType et, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
    if (et == TR::Float) {
 ...
 * @return general purpose register containing the result
 */
static TR::Register* vreductionMulHelper(
    TR::Node* node, TR::DataType et, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
    switch (et) {
    case TR::Int8:
 ...
 * @return general purpose register containing the result
 */
static TR::Register* vreductionOrHelper(
    TR::Node* node, TR::DataType et, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
 ...
 * @return general purpose register containing the result
 */
static TR::Register* vreductionXorHelper(
    TR::Node* node, TR::DataType et, TR::Register* resReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
...
TR::Register* OMR::ARM64::TreeEvaluator::inlineVectorMaskedBinaryOp(
    TR::Node* node, TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, binaryEvaluatorHelper evaluatorHelper)
{
    TR::Node* firstChild = node->getFirstChild();
    TR::Node* secondChild = node->getSecondChild();
    TR::Node* thirdChild = node->getThirdChild();
     ...
     */
    generateTrg1Src2Instruction(
        cg, flipMask ? TR::InstOpCode::vbit16b : TR::InstOpCode::vbif16b, node, resReg, lhsReg, maskReg);
...
TR::Register* OMR::ARM64::TreeEvaluator::inlineVectorMaskedUnaryOp(
    TR::Node* node, TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, unaryEvaluatorHelper evaluatorHelper)
{
    TR::Node* firstChild = node->getFirstChild();
    TR::Node* secondChild = node->getSecondChild();
     ...
     */
    generateTrg1Src2Instruction(
        cg, flipMask ? TR::InstOpCode::vbit16b : TR::InstOpCode::vbif16b, node, resReg, srcReg, maskReg);
...
TR::Register* OMR::ARM64::TreeEvaluator::vmfmaEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
     ...
     */
    generateTrg1Src2Instruction(
        cg, flipMask ? TR::InstOpCode::vbit16b : TR::InstOpCode::vbif16b, node, targetReg, firstReg, maskReg);
    ...
    TR::InstOpCode::Mnemonic op, loadIdentityVectorHelper loadHelper, reductionEvaluatorHelper evaluatorHelper = NULL)
{
     ...
     */
    generateTrg1Src2Instruction(
        cg, flipMask ? TR::InstOpCode::vbif16b : TR::InstOpCode::vbit16b, node, tmpReg, sourceReg, maskReg);
 ...
 * @param[in] cg: CodeGenerator
 */
static void loadIdentityVectorForReductionAnd(
    TR::Node* node, TR::DataType et, TR::Register* identityReg, TR::CodeGenerator* cg)
{
...
TR::Register* OMR::ARM64::TreeEvaluator::vmreductionAndEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    case TR::Int32:
    case TR::Int64:
        return inlineVectorMaskedReductionOp(
            node, cg, et, TR::InstOpCode::bad, loadIdentityVectorForReductionAnd, vreductionAndHelper);
    case TR::Float:
    case TR::Double:
        TR_ASSERT_FATAL_WITH_NODE(
            node, false, "Unexpected element type %s", node->getFirstChild()->getDataType().toString());
 ...
 * @param[in] cg: CodeGenerator
 */
static void loadIdentityVectorForReductionMax(
    TR::Node* node, TR::DataType et, TR::Register* identityReg, TR::CodeGenerator* cg)
{
    switch (et) {
    case TR::Int8:
    ...
    case TR::Int64:
        generateTrg1ImmInstruction(
            cg, TR::InstOpCode::vmovi2d, node, identityReg, 0x80); /* Loads 0xff000000_00000000 into each element */
 ...
 * @param[in] cg: CodeGenerator
 */
static void loadIdentityVectorForReductionMin(
    TR::Node* node, TR::DataType et, TR::Register* identityReg, TR::CodeGenerator* cg)
{
    switch (et) {
    case TR::Int8:
 ...
 * @param[in] cg: CodeGenerator
 */
static void loadIdentityVectorForReductionMul(
    TR::Node* node, TR::DataType et, TR::Register* identityReg, TR::CodeGenerator* cg)
{
    switch (et) {
    case TR::Int8:
    ...
    case TR::Int64:
        generateTrg1ImmInstruction(
            cg, TR::InstOpCode::vmovi2d, node, identityReg, 1); /* Loads 0x00000000_000000ff into each element */
    ...
    case TR::Float:
        generateTrg1ImmInstruction(
            cg, TR::InstOpCode::vfmov4s, node, identityReg, 0x70); /* Loads 0x3f800000 (1.0f) into each element */
        break;
    case TR::Double:
...
TR::Register* OMR::ARM64::TreeEvaluator::vmreductionMulEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    TR::DataType et = node->getFirstChild()->getDataType().getVectorElementType();
    return inlineVectorMaskedReductionOp(
        node, cg, et, TR::InstOpCode::bad, loadIdentityVectorForReductionMul, vreductionMulHelper);
}
 ...
 */
static TR::Register* vpopcntEvaluatorHelper(
    TR::Node* node, TR::Register* resultReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
    TR::DataType et = node->getDataType().getVectorElementType();
...
static TR::Register* vectorShiftImmediateHelper(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    TR_ASSERT_FATAL_WITH_NODE(
        node, (elementType >= TR::Int8) && (elementType <= TR::Int64), "elementType must be integer");
    ...
    if ((value >= start) && (value <= end)) {
        ...
        if (isVectorMaskedShift) {
             ...
             */
            generateTrg1Src2Instruction(
                cg, flipMask ? TR::InstOpCode::vbit16b : TR::InstOpCode::vbif16b, node, targetReg, lhsReg, maskReg);
 ...
 * @return the result register
 */
static TR::Register* vectorRightShiftHelper(
    TR::Node* node, TR::Register* resultReg, TR::Register* lhsReg, TR::Register* rhsReg, TR::CodeGenerator* cg)
{
    TR::VectorOperation vectorOp = node->getOpCode().getVectorOperation();
    TR::DataType elementType = node->getDataType().getVectorElementType();
 ...
 * @return the result register
 */
static TR::Register* vectorRotateHelper(
    TR::Node* node, TR::Register* resultReg, TR::Register* lhsReg, TR::Register* rhsReg, TR::CodeGenerator* cg)
{
    TR::DataType elementType = node->getDataType().getVectorElementType();
    TR_ASSERT_FATAL_WITH_NODE(
 ...
 * @return the result register
 */
static TR::Register* vectorLeadingOrTrailingZeroesHelper(
    TR::Node* node, TR::Register* resultReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
    TR::VectorOperation vectorOp = node->getOpCode().getVectorOperation();
    TR::DataType elementType = node->getDataType().getVectorElementType();
 ...
 * @return the result register
 */
static TR::Register* vectorBitSwapHelper(
    TR::Node* node, TR::Register* resultReg, TR::Register* srcReg, TR::CodeGenerator* cg)
{
    TR::VectorOperation vectorOp = node->getOpCode().getVectorOperation();
    TR::DataType elementType = node->getDataType().getVectorElementType();
    TR_ASSERT_FATAL_WITH_NODE(
        node, (vectorOp == TR::vbitswap) || (vectorOp == TR::vmbitswap), "opcode must be vector bitswap");
    /* We do not expect elementType = TR::Int8 here. */
    TR_ASSERT_FATAL_WITH_NODE(
        node, (elementType >= TR::Int16) && (elementType <= TR::Int64), "elementType must be integer");
    const TR::InstOpCode::Mnemonic revOp = (elementType == TR::Int16) ? TR::InstOpCode::vrev16_16b
        : (elementType == TR::Int32)                                  ? TR::InstOpCode::vrev32_16b
                                                                      : TR::InstOpCode::vrev64_16b;
...
static TR::Instruction* compareIntsAndBranchForArrayCopyBNDCHK(
    TR::ARM64ConditionCode branchCond, TR::Node* node, TR::CodeGenerator* cg, TR::SymbolReference* sr)
{
    TR::Node* firstChild = node->getFirstChild();
    TR::Node* secondChild = node->getSecondChild();
 ...
 */
static void addMetaDataForLoadAddressConstantFixed(
    TR::CodeGenerator* cg, TR::Node* node, TR::Instruction* firstInstruction, int16_t typeAddress, intptr_t value)
{
    if (value == 0x0)
        return;
    ...
    case TR_DataAddress: {
        relo = new (cg->trHeapMemory()) TR::BeforeBinaryEncodingExternalRelocation(firstInstruction,
            (uint8_t*)node->getSymbolReference(), (uint8_t*)(intptr_t)node->getInlinedSiteIndex(), TR_DataAddress, cg);
        break;
    }
    ...
    case TR_MethodEnterExitHookAddress: {
        relo = new (cg->trHeapMemory()) TR::BeforeBinaryEncodingExternalRelocation(
            firstInstruction, (uint8_t*)node->getSymbolReference(), NULL, TR_MethodEnterExitHookAddress, cg);
        break;
    }
    }
    ...
    if (!relo) {
        relo = new (cg->trHeapMemory()) TR::BeforeBinaryEncodingExternalRelocation(
            firstInstruction, (uint8_t*)value, (TR_ExternalRelocationTargetKind)typeAddress, cg);
    }
    ...
    TR::Register* trgReg, TR::Instruction* cursor = NULL, int16_t typeAddress = -1)
{
    ...
    cursor = generateTrg1ImmInstruction(
        cg, TR::InstOpCode::movkx, node, trgReg, ((value >> 16) & 0x0000ffff) | TR::MOV_LSL16, cursor);
    cursor = generateTrg1ImmInstruction(
        cg, TR::InstOpCode::movkx, node, trgReg, ((value >> 32) & 0x0000ffff) | (TR::MOV_LSL16 * 2), cursor);
    cursor = generateTrg1ImmInstruction(
        cg, TR::InstOpCode::movkx, node, trgReg, (value >> 48) | (TR::MOV_LSL16 * 3), cursor);
...
TR::Register* commonLoadEvaluator(
    TR::Node* node, TR::InstOpCode::Mnemonic op, int32_t size, TR::Register* targetReg, TR::CodeGenerator* cg)
{
...
TR::Register* commonStoreEvaluator(TR::Node* node, TR::InstOpCode::Mnemonic op, int32_t size, TR::CodeGenerator* cg)
{
    ...
    if (node->getSymbolReference()->getSymbol()->isShadow() && node->getSymbolReference()->getSymbol()->isOrdered()
...
TR::Register* OMR::ARM64::TreeEvaluator::arraysetEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    if (isLengthConstant) {
        ...
        if (length >= elementSize * 4) {
            ...
            if (length >= 32) {
                    ...
                    if (lenMod32 == 0) {
                        ...
                        if (lenMod32 == 16) {
                            ...
                            generateTrg1Src1ImmInstruction(
                                cg, TR::InstOpCode::addimmx, node, dstEndReg, dstReg, length);
                            if (lenMod32 > 16) {
                                generateMemSrc2Instruction(cg, TR::InstOpCode::vstpoffq, node,
                                    TR::MemoryReference::createWithDisplacement(cg, dstEndReg, -32), vectorValueReg,
                                    vectorValueReg);
                ...
                generateMemSrc1Instruction(
                    cg, op, node, TR::MemoryReference::createWithDisplacement(cg, dstReg, 0), vectorValueReg);
            } else {
                TR::InstOpCode::Mnemonic op = (length >= 16) ? TR::InstOpCode::vstrimmq
                    : (length >= 8)                          ? TR::InstOpCode::vstrimmd
                                                             : TR::InstOpCode::vstrimms;
                ...
                generateMemSrc1Instruction(
                    cg, op, node, TR::MemoryReference::createWithDisplacement(cg, dstReg, 0), vectorValueReg);
                generateMemSrc1Instruction(
                    cg, op, node, TR::MemoryReference::createWithDisplacement(cg, dstEndReg, offset), vectorValueReg);
                srm->reclaimScratchRegister(dstEndReg);
            }
        } else {
        ...
        if (debugObj) {
            ...
            debugObj->addInstructionComment(
                branchToLessThanOrEqual96LabelInstr, "Jumps to lessThanOrEqual96Label if length <= 96.");
        }
        ...
        if (debugObj) {
            ...
            debugObj->addInstructionComment(
                branchBackToMainLoopLabelInstr, "Jumps to mainLoopLabel while the remaining length >= 64.");
            debugObj->addInstructionComment(
                adjustDstRegInstr, "Adjusts dst register so that they point to 64bytes before the end");
        }
        ...
        if (elementSize == 8) {
            ...
            generateMemSrc1Instruction(
                cg, strOpCode, node, TR::MemoryReference::createWithDisplacement(cg, dstReg, elementSize), valueReg);
            ...
            if (debugObj) {
                ...
                debugObj->addInstructionComment(
                    branchBackToElementLoopLabelInstr, "Jumps to elementLoopLabel if the remaining length > 0");
            }
        }
...
static TR::Register* arraycmpEvaluatorHelper(TR::Node* node, TR::CodeGenerator* cg, bool isArrayCmpLen)
{
    ...
    if (!isLengthGreaterThan15) {
        auto ccmpLengthInstr = generateConditionalCompareImmInstruction(
            cg, node, lengthReg, 0, 4, TR::CC_NE, /* is64bit */ true); /* 4 for Z flag */
        if (debugObj) {
    ...
    if (debugObj) {
        debugObj->addInstructionComment(
            branchToDoneLabelInstr, "Done if src1 and src2 are the same array or length is 0.");
    }
    ...
    TR::LabelSymbol* loop16Label = generateLabelSymbol(cg);
    {
        ...
        if (debugObj) {
            ...
            debugObj->addInstructionComment(
                branchToNotEqual16LabelInstr2, "Jumps to notEqual16Label if mismatch is found in the 16-byte data");
    ...
    if (isLengthGreaterThan15) {
        ...
        if (debugObj) {
            if (isArrayCmpLen) {
                debugObj->addInstructionComment(
                    branchToDoneLabelInstr3, "Jumps to done0Label if the remaining length is 0.");
            } else {
                debugObj->addInstructionComment(
                    branchToDoneLabelInstr3, "Jumps to doneLabel if the remaining length is 0.");
            }
            debugObj->addInstructionComment(
                adjustSrc1RegInstr, "Adjusts src registers so that they point to 16bytes before the end");
        ...
        branchToDoneLabelInstr3 = generateCompareBranchInstruction(
            cg, TR::InstOpCode::cbzx, node, lengthReg, isArrayCmpLen ? done0Label : doneLabel);
    ...
    if (isArrayCmpLen) {
        ...
        auto adjustingBaseAddrInstr = generateTrg1Src2ShiftedInstruction(
            cg, TR::InstOpCode::subx, node, src1Reg, src1Reg, data2Reg, TR::SH_LSL, 3);
        ...
        if (debugObj) {
            debugObj->addInstructionComment(
                getOffsetInstr, "register has 1 if mismatch is in the first 8-byte data. Otherwise it has 2.");
    ...
    if (!isLengthGreaterThan15) {
        ...
        generateTrg1MemInstruction(
            cg, TR::InstOpCode::ldrbpost, node, data1Reg, TR::MemoryReference::createWithDisplacement(cg, src1Reg, 1));
        generateTrg1MemInstruction(
            cg, TR::InstOpCode::ldrbpost, node, data2Reg, TR::MemoryReference::createWithDisplacement(cg, src2Reg, 1));
        ...
        if (isArrayCmpLen) {
            ...
            if (debugObj) {
                debugObj->addInstructionComment(
                    adjustSrc1AddrInstr, "Subtracts 1 from src1 if the mismatch is found in the last byte of data.");
            }
        }
    }
...
static void inlineConstantLengthForwardArrayCopy(
    TR::Node* node, int64_t byteLen, TR::Register* srcReg, TR::Register* dstReg, TR::CodeGenerator* cg)
{
    if (byteLen == 0)
        return;
    ...
    while (residue > 0) {
        ...
        generateTrg1MemInstruction(
            cg, loadOp, node, dataReg, TR::MemoryReference::createWithDisplacement(cg, srcReg, offset));
        generateMemSrc1Instruction(
            cg, storeOp, node, TR::MemoryReference::createWithDisplacement(cg, dstReg, offset), dataReg);
        offset += dataSize;
        residue -= dataSize;
    }
...
static void inlineConstantLengthBackwardArrayCopy(
    TR::Node* node, int64_t byteLen, TR::Register* srcReg, TR::Register* dstReg, TR::CodeGenerator* cg)
{
    if (byteLen == 0)
        return;
    ...
    while (residue > 0) {
        ...
        generateTrg1MemInstruction(
            cg, loadOp, node, dataReg, TR::MemoryReference::createWithDisplacement(cg, srcReg, -dataSize));
        generateMemSrc1Instruction(
            cg, storeOp, node, TR::MemoryReference::createWithDisplacement(cg, dstReg, -dataSize), dataReg);
        residue -= dataSize;
    }
    ...
    TR::Register* lengthReg, TR::RegisterDependencyConditions* deps, TR::CodeGenerator* cg)
{
    ...
    generateImmSymInstruction(
        cg, TR::InstOpCode::bl, node, (uintptr_t)arrayCopyHelper->getMethodAddress(), deps, arrayCopyHelper, NULL);
    cg->machine()->setLinkRegisterKilled(true);
...
TR::Register* OMR::ARM64::TreeEvaluator::loadaddrEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    if (mref->getUnresolvedSnippet() != NULL) {
        ...
        if (mref->useIndexedForm()) {
            resultReg = sym->isLocalObject() ? cg->allocateCollectedReferenceRegister() : cg->allocateRegister();
            generateTrg1Src2Instruction(
                cg, TR::InstOpCode::addx, node, resultReg, mref->getBaseRegister(), mref->getIndexRegister());
        } else {
            ...
            if (mref->hasDelayedOffset() || offset != 0) {
                ...
                if (mref->hasDelayedOffset()) {
                    ...
                    if (offset >= 0 && constantIsUnsignedImm12(offset)) {
                        generateTrg1Src1ImmInstruction(
                            cg, TR::InstOpCode::addimmx, node, resultReg, mref->getBaseRegister(), offset);
                    } else {
                        loadConstant64(cg, node, offset, resultReg);
                        generateTrg1Src2Instruction(
                            cg, TR::InstOpCode::addx, node, resultReg, mref->getBaseRegister(), resultReg);
                    }
                }
            } else {
...
TR::Instruction* OMR::ARM64::TreeEvaluator::generateVFTMaskInstruction(
    TR::CodeGenerator* cg, TR::Node* node, TR::Register* dstReg, TR::Register* srcReg, TR::Instruction* preced)
{
    // Do nothing in OMR
    return preced;
}
...
TR::Instruction* OMR::ARM64::TreeEvaluator::generateVFTMaskInstruction(
    TR::CodeGenerator* cg, TR::Node* node, TR::Register* reg, TR::Instruction* preced)
{
    // Do nothing in OMR
    return preced;
}
...
static TR::Register* intrinsicAtomicAdd(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    if (comp->target().cpu.supportsFeature(OMR_FEATURE_ARM64_LSE) && (!disableLSE)) {
        ...
        generateTrg1MemSrc1Instruction(
            cg, op, node, valueReg, TR::MemoryReference::createWithDisplacement(cg, addressReg, 0), newValueReg);
    } else {
        /*
        ...
        generateTrg1MemInstruction(
            cg, loadop, node, oldValueReg, TR::MemoryReference::createWithDisplacement(cg, addressReg, 0));

        generateTrg1Src2Instruction(
            cg, (is64Bit ? TR::InstOpCode::addx : TR::InstOpCode::addw), node, newValueReg, oldValueReg, valueReg);
...
TR::Register* intrinsicAtomicFetchAndAdd(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    if (comp->target().cpu.supportsFeature(OMR_FEATURE_ARM64_LSE) && (!disableLSE)) {
         ...
         */
        generateTrg1MemSrc1Instruction(
            cg, op, node, valueReg, TR::MemoryReference::createWithDisplacement(cg, addressReg, 0), oldValueReg);
    } else {
        int64_t value = 0;
        bool negate = false;
        ...
        auto storeop = is64Bit ? TR::InstOpCode::stlxrx : TR::InstOpCode::stlxrw;
        generateTrg1MemSrc1Instruction(
            cg, storeop, node, tempReg, TR::MemoryReference::createWithDisplacement(cg, addressReg, 0), newValueReg);
...
TR::Register* intrinsicAtomicSwap(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    if (comp->target().cpu.supportsFeature(OMR_FEATURE_ARM64_LSE) && (!disableLSE)) {
        ...
        auto storeop = is64Bit ? TR::InstOpCode::stlxrx : TR::InstOpCode::stlxrw;
        generateTrg1MemSrc1Instruction(
            cg, storeop, node, tempReg, TR::MemoryReference::createWithDisplacement(cg, addressReg, 0), valueReg);
        generateCompareBranchInstruction(cg, TR::InstOpCode::cbnzx, node, tempReg, loopLabel);
