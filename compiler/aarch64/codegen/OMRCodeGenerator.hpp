 ...
 */
extern TR::Instruction* loadConstant32(
    TR::CodeGenerator* cg, TR::Node* node, int32_t value, TR::Register* trgReg, TR::Instruction* cursor = NULL);
/**
 ...
 * @param[in] cursor : instruction cursor
 */
extern TR::Instruction* loadConstant64(
    TR::CodeGenerator* cg, TR::Node* node, int64_t value, TR::Register* trgReg, TR::Instruction* cursor = NULL);
...
extern TR::Instruction* loadAddressConstant(TR::CodeGenerator* cg, TR::Node* node, intptr_t value, TR::Register* trgReg,
    TR::Instruction* cursor = NULL, bool isPicSite = false, int16_t typeAddress = -1);
...
extern TR::Instruction* loadAddressConstantInSnippet(TR::CodeGenerator* cg, TR::Node* node, intptr_t address,
    TR::Register* trgReg, TR_ExternalRelocationTargetKind reloKind, bool isClassUnloadingConst = false,
...
public:
    TR_ARM64ScratchRegisterManager(int32_t capacity, TR::CodeGenerator* cg)
...
public:
     ...
     */
    TR_GlobalRegisterNumber pickRegister(TR::RegisterCandidate* regCan, TR::Block** barr,
