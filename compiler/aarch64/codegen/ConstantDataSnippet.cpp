...
TR::ARM64ConstantDataSnippet::ARM64ConstantDataSnippet(
    TR::CodeGenerator* cg, TR::Node* n, void* c, size_t size, TR_ExternalRelocationTargetKind reloType)
        ...
        case TR_ClassPointer:
            if (cg()->comp()->getOption(TR_UseSymbolValidationManager)) {
                ...
                cg()->addExternalRelocation(TR::ExternalRelocation::create(cursor, getData<uint8_t*>(),
                                                reinterpret_cast<uint8_t*>(symbolKind), TR_SymbolFromManager, cg()),
                ...
                cg()->addExternalRelocation(TR::ExternalRelocation::create(cursor, reinterpret_cast<uint8_t*>(node),
        ...
        if (std::find(cg()->getMethodSnippetsToBePatchedOnClassUnload()->begin(),
            ...
            auto classPointer = cg()->fe()
                                    ->createResolvedMethod(
                                        cg()->trMemory(), getData<TR_OpaqueMethodBlock*>(), comp->getCurrentMethod())
                                    ->classOfMethod();
...
void TR::ARM64ConstantDataSnippet::print(TR::FILE* pOutFile, TR_Debug* debug)
{
    ...
    case 4:
        ...
        break;
    case 8:
        trfprintf(pOutFile, "0x%016llx | %lld | double %g", getData<int64_t>(), getData<int64_t>(), getData<double>());
        break;
    default:
