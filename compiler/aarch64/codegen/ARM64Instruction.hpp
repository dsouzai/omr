 ...
 */
enum class ARM64PrefetchType { LOAD = 0, INSTRUCTION = 1, STORE = 2 };

/*
 * Prefetch target used in PRFM instructions
 */
enum class ARM64PrefetchTarget { L1 = 0, L2 = 1, L3 = 2 };

/*
 * Prefetch policy used in PRFM instructions
 */
enum class ARM64PrefetchPolicy { KEEP = 0, STRM = 1 };
 ...
 */
inline bool constantIsImm7(int32_t intValue) { return (-64 <= intValue && intValue < 64); }
 ...
 */
inline bool constantIsImm9(int64_t intValue) { return (-256 <= intValue && intValue < 256); }
 ...
 */
inline bool constantIsSignedImm16(intptr_t intValue) { return (-0x8000 <= intValue && intValue < 0x8000); }
 ...
 */
inline bool constantIsSignedImm21(intptr_t intValue) { return (-0x100000 <= intValue && intValue < 0x100000); }
...
public:
     ...
     * @param[in] instruction : instruction address
     */
    void insertImmediateField(uintptr_t* instruction) { *instruction = _sourceImmediate; }
     ...
     */
    TR_ExternalRelocationTargetKind setReloKind(TR_ExternalRelocationTargetKind reloKind)
    {
        return (_reloKind = reloKind);
    }
    /**
...
public:
     ...
     * @param[in] instruction : instruction cursor
     */
    void insertConditionCodeField(uint32_t* instruction) { *instruction |= (_cc & 0xf); }
...
public:
    ...
    ARM64CompareBranchInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* sreg, TR::LabelSymbol* sym, TR::CodeGenerator* cg)
        : ARM64LabelInstruction(op, node, sym, cg)
...
public:
     ...
     * @param[in] instruction : instruction cursor
     */
    void insertConditionCodeField(uint32_t* instruction) { *instruction |= ((_cc & 0xf) << 12); }
...
public:
     ...
     * @param[in] cg : CodeGenerator
     */
    ARM64Trg1ImmInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, uint32_t imm, TR::CodeGenerator* cg)
        : ARM64Trg1Instruction(op, node, treg, cg)
        , _sourceImmediate(imm)
    { }
...
public:
     ...
     */
    ARM64Trg1ZeroImmInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, bool N, uint32_t imm, TR::CodeGenerator* cg)
        : ARM64Trg1Instruction(op, node, treg, cg)
        , _source1Immediate(imm)
        , _Nbit(N)
    { }
...
public:
     ...
     * @param[in] instruction : instruction cursor
     */
    void insertImmediateField(uint32_t* instruction) { *instruction |= ((_sourceImmediate & 0xf) << 11); }
...
public:
     ...
     * @param[in] cg : CodeGenerator
     */
    ARM64MemImmInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::MemoryReference* mr, uint32_t immediate, TR::CodeGenerator* cg)
        : ARM64MemInstruction(op, node, mr, cg)
     ...
     * @param[in] instruction : instruction cursor
     */
    void insertImmediateField(uint32_t* instruction) { *instruction |= (_immediate & 0x1f); /* imm5 */ }
...
public:
    ...
    ARM64ZeroSrc1ImmInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* sreg, uint32_t imm, TR::CodeGenerator* cg)
     ...
     */
    ARM64ZeroSrc1ImmInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* sreg, bool N, uint32_t imm, TR::CodeGenerator* cg)
        : ARM64Src1Instruction(op, node, sreg, cg)
        , _source1Immediate(imm)
        , _Nbit(N)
    { }
...
public:
     ...
     * @param[in] cg : CodeGenerator
     */
    ARM64Src2Instruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* s1reg, TR::Register* s2reg, TR::CodeGenerator* cg)
...
public:
     ...
     * @param[in] cg : CodeGenerator
     */
    ARM64SynchronizationInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, uint32_t imm, TR::CodeGenerator* cg)
     ...
     * @param[in] cg : CodeGenerator
     */
    ARM64SynchronizationInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, uint32_t imm,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
