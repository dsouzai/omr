...
public:
    ...
    /**
     * @brief Helper for generating instructions for the multiplication operation of vectors with 64-bit integer
     * elements
     *
     * @param[in] node: node
     ...
     */
    static TR::Register* vmulInt64Helper(
     ...
     * @return the result register
     */
    static TR::Register* vdivIntHelper(
     ...
     */
    static TR::Instruction* vsplatsImmediateHelper(
     ...
     * @return the result register
     */
    static TR::Register* vminInt64Helper(
        TR::Node* node, TR::Register* resReg, TR::Register* lhsReg, TR::Register* rhsReg, TR::CodeGenerator* cg);
     ...
     * @return the result register
     */
    static TR::Register* vmaxInt64Helper(
        TR::Node* node, TR::Register* resReg, TR::Register* lhsReg, TR::Register* rhsReg, TR::CodeGenerator* cg);

    typedef TR::Register* (*binaryEvaluatorHelper)(
        TR::Node* node, TR::Register* resReg, TR::Register* lhsRes, TR::Register* rhsReg, TR::CodeGenerator* cg);
    /**
    ...
    typedef TR::Register* (*unaryEvaluatorHelper)(
