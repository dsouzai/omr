...
public:
     ...
     */
    static TR::Register *vmulInt64Helper(TR::Node *node, TR::Register *productReg, TR::Register *lhsReg,
     ...
     * @return the result register
     */
    static TR::Register *vdivIntHelper(TR::Node *node, TR::Register *resReg, TR::Register *lhsReg, TR::Register *rhsReg,
        TR::CodeGenerator *cg);
     ...
     */
    static TR::Instruction *vsplatsImmediateHelper(TR::Node *node, TR::CodeGenerator *cg, TR::Node *firstChild,
        TR::DataType elementType, TR::Register *treg);
     ...
     * @return the result register
     */
    static TR::Register *vminInt64Helper(TR::Node *node, TR::Register *resReg, TR::Register *lhsReg,
        TR::Register *rhsReg, TR::CodeGenerator *cg);
     ...
     * @return the result register
     */
    static TR::Register *vmaxInt64Helper(TR::Node *node, TR::Register *resReg, TR::Register *lhsReg,
        TR::Register *rhsReg, TR::CodeGenerator *cg);

    typedef TR::Register *(*binaryEvaluatorHelper)(TR::Node *node, TR::Register *resReg, TR::Register *lhsRes,
        TR::Register *rhsReg, TR::CodeGenerator *cg);
    /**
    ...
    typedef TR::Register *(
        *unaryEvaluatorHelper)(TR::Node *node, TR::Register *resReg, TR::Register *srcReg, TR::CodeGenerator *cg);
    /**
