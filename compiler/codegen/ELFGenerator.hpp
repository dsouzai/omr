...
#define ELFClass ELFCLASS32;
     ...
     */
    void initializeTextSection(uint32_t shName, ELFAddress shAddress, ELFOffset shOffset, uint32_t shSize);
     ...
     * @param[in] shSize the section header size
     */
    void initializeDataSection(uint32_t shName, ELFAddress shAddress, ELFOffset shOffset, uint32_t shSize);
     ...
     */
    void initializeDynSymSection(uint32_t shName, ELFOffset shOffset, uint32_t shSize, uint32_t shLink);
     ...
     * @param[in] shSize the section header size
     */
    void initializeStrTabSection(uint32_t shName, ELFOffset shOffset, uint32_t shSize);
     ...
     * @param[in] shSize the section header size
     */
    void initializeDynStrSection(uint32_t shName, ELFOffset shOffset, uint32_t shSize);
     ...
     * @param[in] shSize the section header size
     */
    void initializeRelaSection(uint32_t shName, ELFOffset shOffset, uint32_t shSize);
...
public:
     ...
     * @return bool whether emitting ELF file succeeded
     */
    bool emitELF(const char* filename, TR::CodeCacheSymbol* symbols, uint32_t numSymbols,
        uint32_t totalELFSymbolNamesLength, TR::CodeCacheRelocationInfo* relocations, uint32_t numRelocations);
