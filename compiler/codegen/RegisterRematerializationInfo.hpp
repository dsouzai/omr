...
public:
    ...
    TR_RematerializationInfo(
        TR::Instruction* instr, TR_RematerializableTypes type, TR::SymbolReference* symRef, TR::Register* baseReg)
        : _definition(instr)
        , _type(type)
        , _NodeForwardDeclinition(NULL)
    {
    ...
    TR_RematerializationInfo(
        TR::Instruction* instr, TR_RematerializableTypes type, TR::Register* spillReg, TR::Node* defNode)
        : _definition(instr)
        , _type(type)
