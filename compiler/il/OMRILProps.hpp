...
#define THREE_CHILD(type1, type2, type3) \
    CHILD_COUNT(3ULL) | FIRST_CHILD(type1) | SECOND_CHILD(type2) | THIRD_CHILD(type3)
#define FOUR_CHILD(type1, type2, type3, type4) \
    CHILD_COUNT(4ULL) | FIRST_CHILD(type1) | SECOND_CHILD(type2) | THIRD_CHILD(type3) | FOURTH_CHILD(type4)
#define FIVE_CHILD(type1, type2, type3, type4, type5)                                                       \
    CHILD_COUNT(5ULL) | FIRST_CHILD(type1) | SECOND_CHILD(type2) | THIRD_CHILD(type3) | FOURTH_CHILD(type4) \
        | FIFTH_CHILD(type5)
#define SIX_CHILD(type1, type2, type3, type4, type5, type6)                                                 \
    CHILD_COUNT(6ULL) | FIRST_CHILD(type1) | SECOND_CHILD(type2) | THIRD_CHILD(type3) | FOURTH_CHILD(type4) \
        | FIFTH_CHILD(type5) | SIXTH_CHILD(type6)
#define SEVEN_CHILD(type1, type2, type3, type4, type5, type6, type7)                                        \
    CHILD_COUNT(7ULL) | FIRST_CHILD(type1) | SECOND_CHILD(type2) | THIRD_CHILD(type3) | FOURTH_CHILD(type4) \
        | FIFTH_CHILD(type5) | SIXTH_CHILD(type6) | SEVENTH_CHILD(type7)
...
enum {
    ...
    SkipDynamicLitPoolOnInts = 0x00004000, ///< do not perform dynamicLiteralPool on any integral constant children of
                                           ///< this node (used for lengths of array ops)
    Abs = 0x00008000,
    ...
    MaskReduction = 0x00040000, ///< Indicates if opcode performs mask reduction that produces scalar result
