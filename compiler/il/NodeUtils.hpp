...
struct CaseInfo {
    ...
    CASECONST_TYPE getConst() { return _caseConstant; }
...
public:
    ...
    void add(TR::Node* from, TR::Node* to, TR_Memory* m) { _mappings.add(new (m->trStackMemory()) Mapper(from, to)); }
