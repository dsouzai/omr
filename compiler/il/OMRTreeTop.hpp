...
public:
    ...
    static TR::TreeTop* create(
        TR::Compilation* comp, TR::Node* node, TR::TreeTop* next = NULL, TR::TreeTop* prev = NULL);
    ...
    static void insertTreeTops(
        TR::Compilation* comp, TR::TreeTop* beforeInsertionPoint, TR::TreeTop* firstTree, TR::TreeTop* lastTree);
