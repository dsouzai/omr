...
template TR::StaticSymbol* OMR::StaticSymbol::createNamed(
    TR_HeapMemory m, TR::DataType d, void* addr, const char* name);

template TR::StaticSymbol* OMR::StaticSymbol::createNamed(TR_StackMemory m, TR::DataType d, const char* name);
template TR::StaticSymbol* OMR::StaticSymbol::createNamed(
    TR_StackMemory m, TR::DataType d, void* addr, const char* name);

template TR::StaticSymbol* OMR::StaticSymbol::createNamed(PERSISTENT_NEW_DECLARE m, TR::DataType d, const char* name);
template TR::StaticSymbol* OMR::StaticSymbol::createNamed(
    PERSISTENT_NEW_DECLARE m, TR::DataType d, void* addr, const char* name);
