...
public:
     ...
     * form
     *
     * [<tt>\#</tt> <em>outer-method-sig</em>] <tt>\@</tt> <em>bc-offset</em> { <tt>\#</tt> <em>callee-method-sig</em>
     * <tt>\@</tt> <em>bc-offset</em> }*
     *
     ...
     * \param[in] isCaseSensitive Optional.  Specifies whether the case of letters is significant in matching.  Default
     * is \c true. \return \c true if the location matches the specified regular expression; \c false otherwise
     */
