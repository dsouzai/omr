...
struct Link {
    explicit Link(Link* next)
        : _next(next)
    { }
    Link* _next;
};

template<typename T> struct ListElement : public Link {
    typedef T value_type;
    ListElement(Link* tail, const value_type& value)
        : Link(tail)
        , _value(value)
    { }
    value_type _value;
...
public:
    ...
    //   forward_list(size_type size, const value_type& initialValue, const allocator_type &allocator =
    //   allocator_type());
    template<typename InputIterator>
    forward_list(InputIterator first, InputIterator last, const allocator_type& allocator = allocator_type());
    ...
    //   void splice_after(const_iterator position, forward_list &donor, const_iterator nearBound, const_iterator
    //   farBound);
...
// template < typename T, typename Alloc >
// TR::forward_list< T, Alloc >::forward_list(size_type size, const value_type &initialValue, const allocator_type
// &allocator) :
//    _head(NULL),
//    _allocator(allocator)
//    {
...
template<typename T, typename Alloc> TR::forward_list<T, Alloc>::~forward_list() { clear(); }
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::iterator TR::forward_list<T, Alloc>::before_begin()
{
    return iterator(&_head);
}

template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::const_iterator TR::forward_list<T, Alloc>::before_begin() const
{
    return const_iterator(&_head);
}

template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::const_iterator TR::forward_list<T, Alloc>::cbefore_begin() const
{
    return const_cast<const forward_list&>(*this).before_begin();
}

template<typename T, typename Alloc> typename TR::forward_list<T, Alloc>::iterator TR::forward_list<T, Alloc>::begin()
{
    return iterator(_head._next);
}

template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::const_iterator TR::forward_list<T, Alloc>::begin() const
{
    return const_iterator(_head._next);
}

template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::const_iterator TR::forward_list<T, Alloc>::cbegin() const
{
    return const_cast<const forward_list&>(*this).begin();
}

template<typename T, typename Alloc> typename TR::forward_list<T, Alloc>::iterator TR::forward_list<T, Alloc>::end()
{
    return iterator(NULL);
}

template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::const_iterator TR::forward_list<T, Alloc>::end() const
{
    return const_iterator(NULL);
}

template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::const_iterator TR::forward_list<T, Alloc>::cend() const
{
...
template<typename T, typename Alloc> typename TR::forward_list<T, Alloc>::reference TR::forward_list<T, Alloc>::front()
{
    return static_cast<ListElement&>(*_head._next)._value;
}

template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::const_reference TR::forward_list<T, Alloc>::front() const
{
    return static_cast<const ListElement&>(*_head._next)._value;
}

template<typename T, typename Alloc> void TR::forward_list<T, Alloc>::push_front(const value_type& value)
{
...
template<typename T, typename Alloc> void TR::forward_list<T, Alloc>::pop_front()
{
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::iterator TR::forward_list<T, Alloc>::insert_after(
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::iterator TR::forward_list<T, Alloc>::erase_after(iterator position)
{
...
// template < typename T, typename Alloc >
// void
// TR::forward_list< T, Alloc >::splice_after(const_iterator position, forward_list &donor, const_iterator nearBound,
// const_iterator farBound)
//    {
//    }

template<typename T, typename Alloc> void TR::forward_list<T, Alloc>::remove(const value_type& value)
{
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::Link* TR::forward_list<T, Alloc>::const_iterator::degenerate()
{
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::const_iterator& TR::forward_list<T, Alloc>::const_iterator::operator=(
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::const_iterator TR::forward_list<T, Alloc>::const_iterator::operator++(int)
{
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::Link* TR::forward_list<T, Alloc>::iterator::degenerate()
{
    return reinterpret_cast<Link*>(static_cast<uintptr_t>(-1));
}
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::iterator& TR::forward_list<T, Alloc>::iterator::operator=(const iterator& other)
{
    _element = other._element;
    return *this;
}
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::iterator& TR::forward_list<T, Alloc>::iterator::operator++()
{
    _element = _element->_next;
    return *this;
}
...
template<typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::iterator TR::forward_list<T, Alloc>::iterator::operator++(int)
{
