...
TR::CPU OMR::X86::CPU::detect(OMRPortLibrary* const omrPortLib)
{
    ...
    uint32_t const enabledFeatures[] = {
        OMR_FEATURE_X86_FPU,
        OMR_FEATURE_X86_CX8,
        OMR_FEATURE_X86_CMOV,
        OMR_FEATURE_X86_MMX,
        OMR_FEATURE_X86_SSE,
        OMR_FEATURE_X86_SSE2,
        OMR_FEATURE_X86_SSSE3,
        OMR_FEATURE_X86_SSE4_1,
        OMR_FEATURE_X86_SSE4_2,
        OMR_FEATURE_X86_POPCNT,
        OMR_FEATURE_X86_AESNI,
        OMR_FEATURE_X86_OSXSAVE,
        OMR_FEATURE_X86_AVX,
        OMR_FEATURE_X86_AVX2,
        OMR_FEATURE_X86_FMA,
        OMR_FEATURE_X86_HLE,
        OMR_FEATURE_X86_RTM,
        OMR_FEATURE_X86_AVX512F,
        OMR_FEATURE_X86_AVX512VL,
        OMR_FEATURE_X86_AVX512BW,
        OMR_FEATURE_X86_AVX512DQ,
        OMR_FEATURE_X86_AVX512CD,
        OMR_FEATURE_X86_AVX512_VBMI2,
        OMR_FEATURE_X86_AVX512_VPOPCNTDQ,
        OMR_FEATURE_X86_AVX512_BITALG,
        OMR_FEATURE_X86_CLWB,
    };
    ...
    if (TRUE == omrsysinfo_processor_has_feature(&processorDescription, OMR_FEATURE_X86_OSXSAVE)) {
        ...
        if (((6 & _xgetbv(0)) != 6)
            || disableAVX) // '6' = mask for XCR0[2:1]='11b' (XMM state and YMM state are enabled)
        {
...
bool OMR::X86::CPU::supportsFeature(uint32_t feature)
{
    ...
    if (!disableOldVersionCPUDetectionTest)
        TR_ASSERT_FATAL(
            self()->supports_feature_test(feature), "old api and new api did not match, feature %d", feature);
