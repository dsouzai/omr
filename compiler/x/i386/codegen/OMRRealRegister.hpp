...
public:
    ...
    {
        uint8_t regNum = ((_fullRegisterBinaryEncodings[_registerNumber].needsRexForByte << 3)
    ...
    {
        *opcodeByte ^= ((_fullRegisterBinaryEncodings[_registerNumber].needsRexForByte << 3)
                           | _fullRegisterBinaryEncodings[_registerNumber].id)
