...
void TR_X86FPBinaryArithmeticAnalyser::setInputs(
    TR::Node* firstChild, TR::Register* firstRegister, TR::Node* secondChild, TR::Register* secondRegister)
{
    ...
    if (firstChild->getOpCode().isMemoryReference() && firstChild->getReferenceCount() == 1) {
        setMem1();
    }

    if (secondChild->getOpCode().isMemoryReference() && secondChild->getReferenceCount() == 1) {
        setMem2();
    }

    if ((firstChild->getReferenceCount() == 1) && isIntToFPConversion(firstChild)) {
        setConv1();
    }

    if ((secondChild->getReferenceCount() == 1) && isIntToFPConversion(secondChild)) {
        setConv2();
    }
...
bool TR_X86FPBinaryArithmeticAnalyser::isIntToFPConversion(TR::Node* child)
{
    ...
    if (/*child->getOpCodeValue() == TR::i2f ||
        ...
        child->getOpCodeValue() == TR::i2d || child->getOpCodeValue() == TR::s2d) {
...
const TR::InstOpCode::Mnemonic TR_X86FPBinaryArithmeticAnalyser::_opCodePackage[kNumFPPackages][kNumFPArithVariants] = {
    ...
    // Unknown
    { TR::InstOpCode::UD2, TR::InstOpCode::UD2, TR::InstOpCode::UD2, TR::InstOpCode::UD2, TR::InstOpCode::UD2,
        TR::InstOpCode::UD2, TR::InstOpCode::UD2, TR::InstOpCode::UD2 },

    // fadd
    { TR::InstOpCode::FADDRegReg, TR::InstOpCode::FADDRegReg, TR::InstOpCode::FADDRegMem, TR::InstOpCode::FADDRegMem,
        TR::InstOpCode::FSADDRegMem, TR::InstOpCode::FIADDRegMem, TR::InstOpCode::FSADDRegMem,
        TR::InstOpCode::FIADDRegMem },

    // dadd
    { TR::InstOpCode::DADDRegReg, TR::InstOpCode::DADDRegReg, TR::InstOpCode::DADDRegMem, TR::InstOpCode::DADDRegMem,
        TR::InstOpCode::DSADDRegMem, TR::InstOpCode::DIADDRegMem, TR::InstOpCode::DSADDRegMem,
        TR::InstOpCode::DIADDRegMem },

    // fmul
    { TR::InstOpCode::FMULRegReg, TR::InstOpCode::FMULRegReg, TR::InstOpCode::FMULRegMem, TR::InstOpCode::FMULRegMem,
        TR::InstOpCode::FSMULRegMem, TR::InstOpCode::FIMULRegMem, TR::InstOpCode::FSMULRegMem,
        TR::InstOpCode::FIMULRegMem },

    // dmul
    { TR::InstOpCode::DMULRegReg, TR::InstOpCode::DMULRegReg, TR::InstOpCode::DMULRegMem, TR::InstOpCode::DMULRegMem,
        TR::InstOpCode::DSMULRegMem, TR::InstOpCode::DIMULRegMem, TR::InstOpCode::DSMULRegMem,
        TR::InstOpCode::DIMULRegMem },

    // fsub
    { TR::InstOpCode::FSUBRegReg, TR::InstOpCode::FSUBRRegReg, TR::InstOpCode::FSUBRegMem, TR::InstOpCode::FSUBRRegMem,
        TR::InstOpCode::FSSUBRegMem, TR::InstOpCode::FISUBRegMem, TR::InstOpCode::FSSUBRRegMem,
        TR::InstOpCode::FISUBRRegMem },

    // dsub
    { TR::InstOpCode::DSUBRegReg, TR::InstOpCode::DSUBRRegReg, TR::InstOpCode::DSUBRegMem, TR::InstOpCode::DSUBRRegMem,
        TR::InstOpCode::DSSUBRegMem, TR::InstOpCode::DISUBRegMem, TR::InstOpCode::DSSUBRRegMem,
        TR::InstOpCode::DISUBRRegMem },

    // fdiv
    { TR::InstOpCode::FDIVRegReg, TR::InstOpCode::FDIVRRegReg, TR::InstOpCode::FDIVRegMem, TR::InstOpCode::FDIVRRegMem,
        TR::InstOpCode::FSDIVRegMem, TR::InstOpCode::FIDIVRegMem, TR::InstOpCode::FSDIVRRegMem,
        TR::InstOpCode::FIDIVRRegMem },

    // ddiv
    { TR::InstOpCode::DDIVRegReg, TR::InstOpCode::DDIVRRegReg, TR::InstOpCode::DDIVRegMem, TR::InstOpCode::DDIVRRegMem,
        TR::InstOpCode::DSDIVRegMem, TR::InstOpCode::DIDIVRegMem, TR::InstOpCode::DSDIVRRegMem,
        TR::InstOpCode::DIDIVRRegMem }
};
