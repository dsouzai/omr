...
//
TR::RealRegister* assignGPRegister(
    TR::Instruction* instr, TR::Register* virtReg, TR_RegisterSizes requestedRegSize, TR::CodeGenerator* cg)
{
    TR::Machine* machine = cg->machine();
...
TR::X86LabelInstruction::X86LabelInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::LabelSymbol* sym, TR::CodeGenerator* cg)
...
TR::X86LabelInstruction::X86LabelInstruction(
    TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::LabelSymbol* sym, TR::CodeGenerator* cg)
...
void TR::X86LabelInstruction::assignOutlinedInstructions(
    TR_RegisterKinds kindsToBeAssigned, TR::X86LabelInstruction* labelInstruction)
{
...
void TR::X86LabelInstruction::addPostDepsToOutlinedInstructionsBranch()
{
    ...
    TR_ASSERT(
        !_outlinedInstructionBranch->getDependencyConditions(), "not expecting existing reg deps on an OOL branch");
...
void TR::X86LabelInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
    ...
    if (kindsToBeAssigned & TR_GPR_Mask) {
                ...
                if (classObjectRegister != NULL && !classObjectRegister->getRealRegister()) {
                    ...
                    if (assignedClassObjectRegister == NULL
                        ...
                        if ((assignedClassObjectRegister
                            ...
                            != NULL) {
                            machine->coerceGPRegisterAssignment(
                                this, classObjectRegister, assignedClassObjectRegister->getRegisterNumber());
        ...
        if (getDependencyConditions()) {
            ...
            TR_ASSERT(
                cg()->getAssignmentDirection() != cg()->Backward, "Assigning non-GPR registers in a forward pass");
...
TR::X86FenceInstruction::X86FenceInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Node* fenceNode, TR::CodeGenerator* cg)
    : TR::Instruction(node, op, cg)
...
TR::X86ImmInstruction::X86ImmInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, int32_t imm, TR::CodeGenerator* cg, int32_t reloKind)
    : TR::Instruction(node, op, cg)
...
TR::X86ImmSnippetInstruction::X86ImmSnippetInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, int32_t imm, TR::UnresolvedDataSnippet* us, TR::CodeGenerator* cg)
...
TR::X86ImmSymInstruction::X86ImmSymInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, int32_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
    : TR::X86ImmInstruction(imm, node, op, cg)
    , _symbolReference(sr)
{ }
...
TR::X86RegInstruction::X86RegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* reg, TR::CodeGenerator* cg, OMR::X86::Encoding encoding)
...
TR::X86CallMemInstruction::X86CallMemInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::MemoryReference* mr, TR::CodeGenerator* cg)
        ...
        if (kindsToBeAssigned & getSourceRegister()->getKindAsMask()) {
            ...
            if (blockedEbp) {
                ...
                case TR::RealRegister::Unlatched:
                    cg()->machine()->getRealRegister(TR::RealRegister::ebp)->resetState(TR::RealRegister::Unlatched);
                    break;
...
TR::X86FPRegInstruction::X86FPRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* reg, TR::CodeGenerator* cg)
    : TR::X86RegInstruction(reg, node, op, cg)
{ }

TR::X86FPRegInstruction::X86FPRegInstruction(
    TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Register* reg, TR::CodeGenerator* cg)
...
TR::X86FPRegRegInstruction::X86FPRegRegInstruction(
...
TR::X86FPST0ST1RegRegInstruction::X86FPST0ST1RegRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
...
void TR::X86FPST0ST1RegRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
    ...
    if (kindsToBeAssigned & TR_X87_Mask) {
        ...
        TR_ASSERT(
            result & kSourceOnFPStack, "TR::X86FPST0STiRegRegInstruction::assignRegisters ==> source not on FP stack!");

        TR_ASSERT(
            result & kTargetOnFPStack, "TR::X86FPST0STiRegRegInstruction::assignRegisters ==> target not on FP stack!");
...
void TR::X86FPSTiST0RegRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
    ...
    if (kindsToBeAssigned & TR_X87_Mask) {
        ...
        TR_ASSERT(
            result & kSourceOnFPStack, "TR::X86FPSTiST0RegRegInstruction::assignRegisters ==> source not on FP stack!");

        TR_ASSERT(
            result & kTargetOnFPStack, "TR::X86FPSTiST0RegRegInstruction::assignRegisters ==> target not on FP stack!");
        ...
        //        "TR::X86FPSTiST0RegRegInstruction::assignRegisters ==> at least one of source and target must be
        //        popped!");
        ...
        if (_forcePop || ((result & (kSourceCanBePopped | kTargetCanBePopped)))) {
            ...
            //
            if ((_forcePop || (result & kTargetCanBePopped)) && (sourceRegister != targetRegister)) {
...
TR::X86FPST0STiRegRegInstruction::X86FPST0STiRegRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
    : TR::X86FPRegRegInstruction(sreg, treg, node, op, cg)
{ }
...
TR::X86FPArithmeticRegRegInstruction::X86FPArithmeticRegRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
    : TR::X86FPRegRegInstruction(sreg, treg, node, op, cg)
{ }
...
void TR::X86FPArithmeticRegRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
    ...
    if (kindsToBeAssigned & TR_X87_Mask) {
        ...
        // Dead tree elimination doesn't always eliminate dead trees and we can eventually pop the target as well, TODO:
        // ensure proper stack balance. TR_ASSERT( !(result & kTargetCanBePopped),
        //         "TR::X86FPArithmeticRegRegInstruction::assignRegisters ==> target register cannot be popped!" );

        if (result & kSourceCanBePopped) {
            TR::InstOpCode::Mnemonic popOpCode;

            if (!machine->isFPRTopOfStack(sourceRegister) && machine->isFPRTopOfStack(targetRegister)) {
            ...
            //
            if (!machine->isFPRTopOfStack(targetRegister) && !machine->isFPRTopOfStack(sourceRegister)) {
                (void)machine->fpStackFXCH(this->getPrev(), targetRegister);
            }
        }
...
TR::X86FPRemainderRegRegInstruction::X86FPRemainderRegRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
...
TR::X86FPMemRegInstruction::X86FPMemRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::MemoryReference* mr, TR::Register* sreg, TR::CodeGenerator* cg)
    : TR::X86MemRegInstruction(sreg, mr, node, op, cg)
{ }
...
TR::X86FPRegMemInstruction::X86FPRegMemInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::MemoryReference* mr, TR::CodeGenerator* cg)
...
int32_t TR::X86BoundaryAvoidanceInstruction::betterPadLength(
    int32_t oldPadLength, const TR_AtomicRegion* unaccommodatedRegion, int32_t unaccommodatedRegionStart)
{
...
TR::Instruction* generateBreakOnDFSet(TR::CodeGenerator* cg, TR::Instruction* cursor)
{
    ...
    cursor = generateMemImmInstruction(
        cursor, TR::InstOpCode::TEST2MemImm2, generateX86MemoryReference(espReal, 0, cg), dfMask, cg);
...
TR::X86MemInstruction* generateMemInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::MemoryReference* mr, TR::CodeGenerator* cg)
{
...
TR::X86MemInstruction* generateMemInstruction(
    TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::MemoryReference* mr, TR::CodeGenerator* cg)
{
...
TR::X86MemTableInstruction* generateMemTableInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::MemoryReference* mr, ncount_t numEntries, TR::CodeGenerator* cg)
{
...
TR::X86ImmInstruction* generateImmInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, int32_t imm, TR::CodeGenerator* cg)
{
...
TR::X86ImmInstruction* generateImmInstruction(
    TR::Instruction* prev, TR::InstOpCode::Mnemonic op, int32_t imm, TR::CodeGenerator* cg)
{
...
TR::X86RegInstruction* generateRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::CodeGenerator* cg)
{
...
TR::X86RegInstruction* generateRegInstruction(
    TR::Instruction* prev, TR::InstOpCode::Mnemonic op, TR::Register* reg1, TR::CodeGenerator* cg)
{
...
TR::X86PatchableCodeAlignmentInstruction* generatePatchableCodeAlignmentInstruction(
    TR::Instruction* prev, const TR_AtomicRegion* atomicRegions, TR::CodeGenerator* cg)
{
...
TR::X86PaddingInstruction* generatePaddingInstruction(
    TR::Instruction* precedingInstruction, uint8_t length, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86PaddingInstruction(precedingInstruction, length, cg);
}

TR::X86PaddingSnippetInstruction* generatePaddingSnippetInstruction(
    uint8_t length, TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::X86AlignmentInstruction* generateAlignmentInstruction(
    TR::Node* node, uint8_t boundary, uint8_t margin, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86AlignmentInstruction(node, boundary, margin, cg);
}

TR::X86AlignmentInstruction* generateAlignmentInstruction(
    TR::Instruction* precedingInstruction, uint8_t boundary, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86AlignmentInstruction(precedingInstruction, boundary, cg);
}

TR::X86AlignmentInstruction* generateAlignmentInstruction(
    TR::Instruction* precedingInstruction, uint8_t boundary, uint8_t margin, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86AlignmentInstruction(precedingInstruction, boundary, margin, cg);
}

TR::X86LabelInstruction* generateLabelInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::LabelSymbol* sym, TR::CodeGenerator* cg)
{
...
TR::X86LabelInstruction* generateLabelInstruction(
    TR::Instruction* pred, TR::InstOpCode::Mnemonic op, TR::LabelSymbol* sym, TR::CodeGenerator* cg)
{
...
TR::X86LabelInstruction* generateLongLabelInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::LabelSymbol* sym, TR::CodeGenerator* cg)
{
...
TR::X86LabelInstruction* generateJumpInstruction(
    TR::InstOpCode::Mnemonic opCode, TR::Node* jumpNode, TR::CodeGenerator* cg, bool evaluateGlRegDeps)
{
...
TR::X86LabelInstruction* generateConditionalJumpInstruction(
    TR::InstOpCode::Mnemonic opCode, TR::Node* ifNode, TR::CodeGenerator* cg)
{
    TR::X86LabelInstruction* inst;
...
TR::X86FenceInstruction* generateFenceInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Node* fenceNode, TR::CodeGenerator* cg)
{
...
#ifdef J9_PROJECT_SPECIFIC
TR::X86VirtualGuardNOPInstruction* generateVirtualGuardNOPInstruction(
    TR::Node* node, TR_VirtualGuardSite* site, TR::RegisterDependencyConditions* deps, TR::CodeGenerator* cg)
{
    ...
    TR::Register* reg1, TR::Register* reg2, TR::Register* reg3, TR::CodeGenerator* cg, OMR::X86::Encoding encoding)
{
    ...
    TR_ASSERT_FATAL(encoding == OMR::X86::Default ? cg->comp()->target().cpu.supportsAVX() : true,
...
TR::X86ImmSymInstruction* generateImmSymInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, int32_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
{
...
TR::X86ImmSymInstruction* generateImmSymInstruction(
    TR::Instruction* prev, TR::InstOpCode::Mnemonic op, int32_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
{
...
TR::X86ImmSnippetInstruction* generateImmSnippetInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, int32_t imm, TR::UnresolvedDataSnippet* snippet, TR::CodeGenerator* cg)
{
...
TR::X86CallMemInstruction* generateCallMemInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::MemoryReference* mr, TR::CodeGenerator* cg)
{
...
TR::X86ImmSymInstruction* generateHelperCallInstruction(
    TR::Instruction* cursor, TR_RuntimeHelper index, TR::CodeGenerator* cg)
{
...
TR::X86ImmSymInstruction* generateHelperCallInstruction(
    TR::Node* node, TR_RuntimeHelper index, TR::RegisterDependencyConditions* dependencies, TR::CodeGenerator* cg)
{
    TR::SymbolReference* helperSymRef = cg->symRefTab()->findOrCreateRuntimeHelper(index);
    cg->resetIsLeafMethod();
...
TR::X86VFPRestoreInstruction* generateVFPRestoreInstruction(
    TR::Instruction* precedingInstruction, TR::X86VFPSaveInstruction* saveInstruction, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86VFPRestoreInstruction(precedingInstruction, saveInstruction, cg);
}

TR::X86VFPRestoreInstruction* generateVFPRestoreInstruction(
    TR::X86VFPSaveInstruction* saveInstruction, TR::Node* node, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86VFPRestoreInstruction(saveInstruction, node, cg);
}

TR::X86VFPDedicateInstruction* generateVFPDedicateInstruction(
    TR::Instruction* precedingInstruction, TR::RealRegister* framePointerReg, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86VFPDedicateInstruction(precedingInstruction, framePointerReg, cg);
}

TR::X86VFPDedicateInstruction* generateVFPDedicateInstruction(
    TR::RealRegister* framePointerReg, TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::X86VFPDedicateInstruction* generateVFPDedicateInstruction(
    TR::RealRegister* framePointerReg, TR::Node* node, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86VFPDedicateInstruction(framePointerReg, node, cond, cg);
}

TR::X86VFPReleaseInstruction* generateVFPReleaseInstruction(
    TR::Instruction* precedingInstruction, TR::X86VFPDedicateInstruction* dedicateInstruction, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86VFPReleaseInstruction(precedingInstruction, dedicateInstruction, cg);
}

TR::X86VFPReleaseInstruction* generateVFPReleaseInstruction(
    TR::X86VFPDedicateInstruction* dedicateInstruction, TR::Node* node, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86VFPReleaseInstruction(dedicateInstruction, node, cg);
}

TR::X86VFPCallCleanupInstruction* generateVFPCallCleanupInstruction(
    TR::Instruction* precedingInstruction, int32_t adjustment, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86VFPCallCleanupInstruction(precedingInstruction, adjustment, cg);
}

TR::X86VFPCallCleanupInstruction* generateVFPCallCleanupInstruction(
    int32_t adjustment, TR::Node* node, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86VFPCallCleanupInstruction(adjustment, node, cg);
}

TR::X86FPRegInstruction* generateFPRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* reg, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86FPRegInstruction(op, node, reg, cg);
}

TR::X86FPST0ST1RegRegInstruction* generateFPST0ST1RegRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86FPST0ST1RegRegInstruction(op, node, treg, sreg, cg);
}

TR::X86FPST0STiRegRegInstruction* generateFPST0STiRegRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
{
...
TR::X86FPArithmeticRegRegInstruction* generateFPArithmeticRegRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86FPArithmeticRegRegInstruction(op, node, treg, sreg, cg);
}

TR::X86FPRemainderRegRegInstruction* generateFPRemainderRegRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
{
...
TR::X86FPMemRegInstruction* generateFPMemRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::MemoryReference* mr, TR::Register* sreg, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86FPMemRegInstruction(op, node, mr, sreg, cg);
}

TR::X86FPRegMemInstruction* generateFPRegMemInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::MemoryReference* mr, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::X86FPRegMemInstruction(op, node, treg, mr, cg);
}

TR::X86FPReturnInstruction* generateFPReturnInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::AMD64Imm64Instruction* generateImm64Instruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, uint64_t imm, TR::CodeGenerator* cg)
{
    return new (cg->trHeapMemory()) TR::AMD64Imm64Instruction(op, node, imm, cg);
}

TR::AMD64Imm64Instruction* generateImm64Instruction(
    TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, uint64_t imm, TR::CodeGenerator* cg)
{
...
TR::AMD64Imm64SymInstruction* generateImm64SymInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, uint64_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
{
