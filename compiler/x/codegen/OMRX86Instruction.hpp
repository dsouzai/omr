...
extern int32_t memoryBarrierRequired(
...
public:
    ...
    X86PaddingInstruction(
        TR::Instruction* precedingInstruction, uint8_t length, TR_PaddingProperties properties, TR::CodeGenerator* cg)
        : TR::Instruction(TR::InstOpCode::bad, precedingInstruction, cg)
        , _length(length)
        , _properties(properties)
    { }
...
public:
    ...
    virtual int32_t estimateBinaryLength(int32_t currentEstimate);
    virtual uint8_t* generateBinaryEncoding();
    virtual OMR::X86::EnlargementResult enlarge(
...
protected:
    virtual int32_t betterPadLength(
...
public:
    ...
    X86PatchableCodeAlignmentInstruction(
        TR::Instruction* precedingInstruction, const TR_AtomicRegion* atomicRegions, TR::CodeGenerator* cg)
...
public:
    ...
    X86AlignmentInstruction(
        TR::Node* node, uint8_t boundary, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
    ...
    X86AlignmentInstruction(
        TR::Node* node, uint8_t boundary, uint8_t margin, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
        : TR::Instruction(cond, node, TR::InstOpCode::bad, cg)
        , _boundary(boundary)
        , _margin(margin)
        , _minPaddingLength(0)
...
public:
    ...
    X86FenceInstruction(
        TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* n, TR::CodeGenerator* cg);
...
public:
    X86ImmInstruction(
        TR::Node* node, TR::InstOpCode::Mnemonic op, TR::CodeGenerator* cg, int32_t reloKind = TR_NoRelocation)
...
public:
    ...
    AMD64Imm64Instruction(
        uint64_t imm, TR::InstOpCode::Mnemonic op, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
        : TR::Instruction(op, precedingInstruction, cg)
        , _sourceImmediate(imm)
    { }
...
public:
    X86FPRegRegInstruction(
        TR::Register* sreg, TR::Register* treg, TR::Node* node, TR::InstOpCode::Mnemonic op, TR::CodeGenerator* cg)
...
public:
    X86FPArithmeticRegRegInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg);
...
public:
    X86FPRemainderRegRegInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg);
...
public:
    ...
    X86VFPDedicateInstruction(TR::Instruction* precedingInstruction, TR::RealRegister* framePointerReg,
        ...
        : TR::X86RegMemInstruction(
            precedingInstruction, TR::InstOpCode::LEARegMem(), framePointerReg, memref(cg), cond, cg)
    { }
...
TR::X86MemInstruction* generateMemInstruction(
    TR::Instruction*, TR::InstOpCode::Mnemonic op, TR::MemoryReference* mr, TR::CodeGenerator* cg);
...
TR::X86RegInstruction* generateRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, TR::Register* reg1, TR::CodeGenerator* cg);
TR::X86RegInstruction* generateRegInstruction(
...
TR::X86MemInstruction* generateMemInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, TR::MemoryReference* mr, TR::CodeGenerator* cg);
...
TR::Instruction* generateInstruction(
    TR::InstOpCode::Mnemonic, TR::Node*, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg);
...
TR::X86LabelInstruction* generateLabelInstruction(
    TR::Instruction* i, TR::InstOpCode::Mnemonic op, TR::LabelSymbol* sym, TR::CodeGenerator* cg);
...
TR::X86LabelInstruction* generateLongLabelInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, TR::LabelSymbol* sym, TR::CodeGenerator* cg);

TR::X86LabelInstruction* generateJumpInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* jumpNode, TR::CodeGenerator* cg, bool evaluateGlRegDeps = true);

TR::X86LabelInstruction* generateConditionalJumpInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* ifNode, TR::CodeGenerator* cg);

TR::X86FenceInstruction* generateFenceInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, TR::Node*, TR::CodeGenerator* cg);

#ifdef J9_PROJECT_SPECIFIC
TR::X86VirtualGuardNOPInstruction* generateVirtualGuardNOPInstruction(
    TR::Node*, TR_VirtualGuardSite* site, TR::RegisterDependencyConditions* deps, TR::CodeGenerator* cg);
...
TR::X86ImmSymInstruction* generateImmSymInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, int32_t imm, TR::SymbolReference*, TR::CodeGenerator* cg);
TR::X86ImmSymInstruction* generateImmSymInstruction(TR::Instruction* prev, TR::InstOpCode::Mnemonic op, int32_t imm,
    TR::SymbolReference*, TR::RegisterDependencyConditions*, TR::CodeGenerator* cg);
TR::X86ImmSymInstruction* generateImmSymInstruction(
    TR::Instruction* prev, TR::InstOpCode::Mnemonic op, int32_t imm, TR::SymbolReference*, TR::CodeGenerator* cg);
...
TR::X86ImmSnippetInstruction* generateImmSnippetInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, int32_t imm, TR::UnresolvedDataSnippet*, TR::CodeGenerator* cg);
...
TR::X86ImmSymInstruction* generateHelperCallInstruction(
    TR::Node*, TR_RuntimeHelper, TR::RegisterDependencyConditions*, TR::CodeGenerator* cg);
...
TR::X86FPST0ST1RegRegInstruction* generateFPST0ST1RegRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, TR::Register* reg1, TR::Register* reg2, TR::CodeGenerator* cg);
...
TR::X86FPMemRegInstruction* generateFPMemRegInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, TR::MemoryReference* mr, TR::Register* reg1, TR::CodeGenerator* cg);
TR::X86FPRegMemInstruction* generateFPRegMemInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, TR::Register* reg1, TR::MemoryReference* mr, TR::CodeGenerator* cg);

TR::X86FPReturnInstruction* generateFPReturnInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node*, TR::RegisterDependencyConditions*, TR::CodeGenerator* cg);

TR::X86FPReturnImmInstruction* generateFPReturnImmInstruction(
    TR::InstOpCode::Mnemonic cp, TR::Node*, int32_t imm, TR::RegisterDependencyConditions*, TR::CodeGenerator* cg);
