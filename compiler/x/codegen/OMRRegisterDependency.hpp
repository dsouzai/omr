...
public:
    ...
    void printDependencyConditions(
        TR::RegisterDependencyGroup* conditions, uint32_t numConditions, char* prefix, FILE* pOutFile);
...
TR::RegisterDependencyConditions* generateRegisterDependencyConditions(
    TR::Node*, TR::CodeGenerator*, uint32_t = 0, List<TR::Register>* = 0);
