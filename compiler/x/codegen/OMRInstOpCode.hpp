...
class InstOpCode : public OMR::InstOpCode {
    ...
    struct OpCode_t {
        ...
        typename TBuffer::cursor_t encode(
            typename TBuffer::cursor_t cursor, OMR::X86::Encoding encoding, uint8_t rexbits) const;
    ...
    template<class TBuffer>
    inline typename TBuffer::cursor_t encode(
        typename TBuffer::cursor_t cursor, OMR::X86::Encoding encoding, uint8_t rex) const
    {
