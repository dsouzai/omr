...
typedef OMR::X86::FunctionCallData FunctionCallDataConnector;
} // namespace OMR
#endif
...
public:
    ...
    FunctionCallData(TR::CodeGenerator* cg, TR::SymbolReference* methodSymRef, TR::Node* callNode,
        TR::Register* scratchReg, uintptr_t targetAddress, TR::RegisterDependencyConditions* regDeps,
        TR_RuntimeHelper runtimeHelperIndex, TR::Instruction* prevInstr, int32_t reloKind,
        int32_t adjustsFramePointerBy, bool useSymInstruction, uint8_t* bufferAddress, bool useCall)
