...
#ifndef OMR_X86_JITCODERX_OBJECTFORMAT_INCL
#define OMR_X86_JITCODERX_OBJECTFORMAT_INCL
...
namespace OMR {
 namespace X86 { class JitCodeRXObjectFormat; }
 typedef OMR::X86::JitCodeRXObjectFormat JitCodeRXObjectFormatConnector;
}
#endif
