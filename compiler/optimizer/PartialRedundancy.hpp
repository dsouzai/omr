...
public:
    ...
    bool eliminateRedundantSupportedNodes(
        TR::Node*, TR::Node*, bool, TR::TreeTop*, int32_t, vcount_t, ContainerType*, ContainerType*, TR::Node**);
    TR::TreeTop* replaceOptimalSubNodes(
        TR::TreeTop* curTree, TR::Node*, TR::Node*, int32_t, TR::Node*, TR::Node*, bool, int32_t, vcount_t);
...
class TR_RedundantExpressionAdjustment : public TR_IntersectionBitVectorAnalysis {
public:
