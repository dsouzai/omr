...
public:
    ...
    struct ExtraAnalysisInfo {
        ...
        TR_ContainerNodeNumberPair *getContainerNodeNumberPair(TR_LinkHead<TR_ContainerNodeNumberPair> *list,
            int32_t n);
...
class TR_IntersectionDFSetAnalysis<Container *> : public TR_ForwardDFSetAnalysis<Container *> {
public:
...
private:
    void initializeGenAndKillSetInfoForNode(TR::Node *node, TR_BitVector &defsKilled, bool seenException,
...
public:
    TR_BackwardUnionSingleBitContainerAnalysis(TR::Compilation *comp, TR::CFG *cfg, TR::Optimizer *optimizer,
        bool trace)
...
public:
    ...
    void findCommonedLoads(TR::Node *node, TR_BitVector *commonedLoads, bool movingForwardThroughTrees,
        vcount_t visitCount);
...
public:
    TR_FlowSensitiveEscapeAnalysis(TR::Compilation *comp, TR::Optimizer *optimizer, TR_Structure *rootStructure,
        TR_EscapeAnalysis *e);
