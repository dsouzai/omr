...
TR_ExceptionCheckMotion* TR_DataFlowAnalysis::asExceptionCheckMotion() { return NULL; }
TR_RedundantExpressionAdjustment* TR_DataFlowAnalysis::asRedundantExpressionAdjustment() { return NULL; }
...
//    {return NULL;}
TR_GlobalAnticipatability* TR_DataFlowAnalysis::asGlobalAnticipatability() { return NULL; }
TR_Earliestness* TR_DataFlowAnalysis::asEarliestness() { return NULL; }
TR_Delayedness* TR_DataFlowAnalysis::asDelayedness() { return NULL; }
TR_Latestness* TR_DataFlowAnalysis::asLatestness() { return NULL; }
TR_Isolatedness* TR_DataFlowAnalysis::asIsolatedness() { return NULL; }
TR_Liveness* TR_DataFlowAnalysis::asLiveness() { return NULL; }
TR_LiveOnAllPaths* TR_DataFlowAnalysis::asLiveOnAllPaths() { return NULL; }
TR_FlowSensitiveEscapeAnalysis* TR_DataFlowAnalysis::asFlowSensitiveEscapeAnalysis() { return NULL; }
...
bool TR_DataFlowAnalysis::collectCallSymbolReferencesInTreeInto(
    TR::Node* node, List<TR::SymbolReference>* callSymbolReferencesInTree)
{
    bool flag = false;
...
bool TR_DataFlowAnalysis::collectAllSymbolReferencesInTreeInto(
    TR::Node* node, List<TR::SymbolReference>* allSymbolReferencesInTree)
{
    bool flag = false;
