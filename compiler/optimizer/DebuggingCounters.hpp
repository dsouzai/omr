...
private:
    ...
    // Methods
    static NamedCounterInfo* getOrCreateNamedCounter(
    ...
    static bool insertIfMissing(
        TR::Compilation* comp, const char* name, bool flag, TR::TreeTop* tt, int32_t size = 0, int32_t numLocals = 0);
