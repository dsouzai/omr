...
private:
    ...
    const BitVector& getUseDef_ref_body(
        int32_t useIndex, TR_BitVector* visitedDefs, TR_UseDefInfo::BitVector* defs = NULL);
...
private:
    ...
    bool assignAdjustedNodeIndex(TR::Block*, TR::Node* node, TR::Node* parent, TR::TreeTop* treeTop, AuxiliaryData& aux,
