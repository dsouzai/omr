...
TR_ValueNumberInfo::TR_ValueNumberInfo(
    TR::Compilation* comp, TR::Optimizer* optimizer, bool requiresGlobals, bool prefersGlobals, bool noUseDefInfo)
    : _compilation(comp)
...
TR_HashValueNumberInfo::TR_HashValueNumberInfo(
    TR::Compilation* comp, TR::Optimizer* optimizer, bool requiresGlobals, bool prefersGlobals, bool noUseDefInfo)
