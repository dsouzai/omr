                ...
                default: // TR_no == isDstArrayCompTypePrimitiveValueType
                {
                    if (isValueTypeArrayFlatteningEnabled) {
                        if (isSrcArrayCompTypePrimitiveValueType == TR_yes) {
                            ...
                            // The source might or might not be a primitive VT array. If it is primitive VT array that
                            // is flattened, the arraycopy instruction cannot handle copying from flattened array into
                            // non-flattened array since the destination array is identity type. Need to add runtime
                            // check here
                            doRuntimeNullRestrictedTest = true;
