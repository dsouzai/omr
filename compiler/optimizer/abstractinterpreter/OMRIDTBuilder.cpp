...
void OMR::IDTBuilder::buildIDT2(TR::IDTNode *node, TR::vector<TR::AbsValue *, TR::Region &> *arguments, int32_t budget,
    ...
    TR::vector<TR::AbsValue *, TR::Region &> *arguments, TR_CallStack *callStack)
{
    ...
    for (int32_t i = 0; i < callSite->numTargets(); i++) {
        ...
        if (!comp()->incInlineDepth(calleeMethodSymbol, callSite->_bcInfo, callSite->_cpIndex, NULL,
                !callSite->isIndirectCall(), 0))
            continue;
...
uint32_t OMR::IDTBuilder::computeStaticBenefit(TR::InliningMethodSummary *summary,
...
void OMR::IDTBuilder::Visitor::visitCallSite(TR_CallSite *callSite, TR::Block *callBlock,
    TR::vector<TR::AbsValue *, TR::Region &> *arguments)
{
