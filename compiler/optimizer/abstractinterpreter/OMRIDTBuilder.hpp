...
protected:
    ...
    public:
        ...
        virtual void visitCallSite(
            TR_CallSite* callSite, TR::Block* callBlock, TR::vector<TR::AbsValue*, TR::Region&>* arguments);
    ...
    void performAbstractInterpretation(
        TR::IDTNode* node, OMR::IDTBuilder::Visitor& visitor, TR::vector<TR::AbsValue*, TR::Region&>* arguments)
    {
        TR_UNIMPLEMENTED();
    }
     ...
     */
    void buildIDT2(
        TR::IDTNode* node, TR::vector<TR::AbsValue*, TR::Region&>* arguments, int32_t budget, TR_CallStack* callStack);
    ...
    uint32_t computeStaticBenefit(
        TR::InliningMethodSummary* summary, TR::vector<TR::AbsValue*, TR::Region&>* arguments);
