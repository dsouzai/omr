...
protected:
    ...
    bool inlineCallTarget2(TR_CallStack *, TR_CallTarget *calltarget, TR::TreeTop **cursorTreeTop, bool inlinefromgraph,
        int32_t);

    // inlineCallTarget2 methods
    bool tryToInlineTrivialMethod(TR_CallStack *callStack, TR_CallTarget *calltarget);

    bool tryToGenerateILForMethod(TR::ResolvedMethodSymbol *calleeSymbol, TR::ResolvedMethodSymbol *callerSymbol,
...
class OMR_InlinerUtil
    : public TR::OptimizationUtil
    , public OMR_InlinerHelper {
    friend class TR_InlinerBase;
...
public:
    ...
    virtual void clearArgInfoForNonInvariantArguments(TR_PrexArgInfo *argInfo, TR::ResolvedMethodSymbol *methodSymbol,
...
protected:
    ...
    virtual void calleeTreeTopPreMergeActions(TR::ResolvedMethodSymbol *calleeResolvedMethodSymbol,
        TR_CallTarget *calltarget);
...
public:
    TR_HandleInjectedBasicBlock(TR::Compilation *, TR_InlinerTracer *, TR::ResolvedMethodSymbol *,
        List<TR::SymbolReference> &, List<TR::SymbolReference> &, List<TR::SymbolReference> &,
        TR_ParameterMapping * = 0);
