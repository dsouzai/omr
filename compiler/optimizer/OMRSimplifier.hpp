...
public:
     ...
     */
    virtual bool isLegalToUnaryCancel(TR::Node* node, TR::Node* firstChild, TR::ILOpCodes opcode) { return true; }
     ...
     */
    virtual bool isLegalToFold(TR::Node* node, TR::Node* firstChild) { return true; }
     ...
     */
    virtual TR::Node* simplifyiCallMethods(TR::Node* node, TR::Block* block) { return node; }
     ...
     * transformations are done; otherwise it returns the original node
     */
    virtual TR::Node* simplifylCallMethods(TR::Node* node, TR::Block* block) { return node; }
     ...
     * transformations are done; otherwise it returns the original node
     */
    virtual TR::Node* simplifyaCallMethods(TR::Node* node, TR::Block* block) { return node; }
     ...
     */
    virtual TR::Node* simplifyiOrPatterns(TR::Node* node) { return NULL; }
     ...
     * is recognized and transformations are done; NULL otherwise
     */
    virtual TR::Node* simplifyi2sPatterns(TR::Node* node) { return NULL; }
     ...
     * is recognized and transformations are done; NULL otherwise
     */
    virtual TR::Node* simplifyd2fPatterns(TR::Node* node) { return NULL; }
     ...
     * is recognized and transformations are done; NULL otherwise
     */
    virtual TR::Node* simplifyIndirectLoadPatterns(TR::Node* node) { return NULL; }
