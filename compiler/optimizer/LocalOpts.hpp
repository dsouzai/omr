...
public:
    ...
    bool replacePassThroughIfPossible(
        TR::Node*, TR::Node*, TR::Node*, TR::Node*, bool*, TR_BitVector*, vcount_t, vcount_t, TR::TreeTop*);
...
private:
    ...
    int32_t processNode(
        TR::Node* node, int32_t blockIndex, TR_Array<uint32_t>* synergyIndices, TR_Array<Synergy>* synergies = NULL);
...
public:
    ...
    //
    static TR_ByteCodeInfo temporarilySetProfilingBcInfoOnNewArrayLengthChild(
