...
#define NODES_PER_CHUNK 3
    ...
    int hasOldExpressionOnRhs(
        TR::Node* node, bool recalcContainsCall = true, bool containsCallInStoreLhsSubTree = false);
...
public:
    ...
    static bool isSupportedNodeForFunctionality(
        TR::Node* node, TR::Compilation* comp, TR::Node* parent, bool isSupportedStoreNode = false);
    static bool isSupportedNode(
        TR::Node* node, TR::Compilation* comp, TR::Node* parent, bool isSupportedStoreNode = false);
...
public:
    ...
    void updateUsesAndDefs(TR::Node*, ContainerType*, ContainerType*, ContainerType*, ContainerType*, ContainerType*,
        vcount_t, ContainerType*, TR_BitVector*, ContainerType*);
...
public:
    ...
    bool updateAnticipatabilityForSupportedNodes(TR::Node*, ContainerType*, ContainerType*, TR::Block*, ContainerType*,
        ContainerType*, ContainerType*, TR_BitVector*, ContainerType*, vcount_t);
    ...
    bool adjustInfoForAddressAdd(
        TR::Node*, TR::Node*, ContainerType*, ContainerType*, ContainerType*, ContainerType*, TR::Block*);
    bool loadaddrAsLoad() { return _loadaddrAsLoad; }
