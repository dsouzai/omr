...
protected:
   ...
   void collectBlocks();
   virtual void collectReferencedAutoSymRefs(TR::Node *node, TR_BitVector &referencedAutoSymRefs, TR::NodeChecklist &visited);
...
public:
   ...
   virtual void processLiveOnEntryBlocks(TR::Block * *, int32_t *, TR::Compilation *,
                                 TR_Array<int32_t>&,TR_Array<int32_t>&, TR_Array<int32_t>&,
...
protected:
   ...
   TR::RegisterCandidate * reprioritizeCandidates(TR::RegisterCandidate *, TR::Block * *, int32_t *, int32_t, TR::Block *, TR::Compilation *,
