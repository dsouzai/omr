...
protected:
    void collectBlocks();
    virtual void collectReferencedAutoSymRefs(
...
public:
    ...
    void addAllBlocksInStructure(TR_Structure*, TR::Compilation*, const char* description, vcount_t count = MAX_VCOUNT,
    ...
    void setWeight(TR::Block**, int32_t*, TR::Compilation*, TR_Array<int32_t>&, TR_Array<int32_t>&, TR_Array<int32_t>&,
    ...
    void removeAssignedCandidateFromLoop(TR::Compilation*, TR_Structure*, int32_t, TR_BitVector*, TR_BitVector*, bool);
    ...
    bool prevBlockTooRegisterConstrained(
        TR::Compilation* comp, TR::Block*, TR_Array<int32_t>&, TR_Array<int32_t>&, TR_Array<int32_t>&);
...
protected:
    ...
    TR::RegisterCandidate* reprioritizeCandidates(TR::RegisterCandidate*, TR::Block**, int32_t*, int32_t, TR::Block*,
        TR::Compilation*, bool reprioritizeFP, bool onlyReprioritizeLongs, TR_BitVector* referencedBlocks,
