...
protected:
    ...
    bool detectInvariantConditionals(
        TR_RegionStructure* whileLoop, List<TR::TreeTop>*, bool, bool*, SharedSparseBitVector& reverseBranchInLoops);
    bool detectInvariantNodes(
    ...
    LoopEntryPrep* addLoopEntryPrepDep(
        LoopEntryPrep::Kind, TR::Node*, TR::list<LoopEntryPrep*, TR::Region&>*, TR::NodeChecklist*);
    ...
    LoopEntryPrep* createLoopEntryPrep(
        LoopEntryPrep::Kind, TR::Node*, TR::NodeChecklist* = NULL, LoopEntryPrep* = NULL);
