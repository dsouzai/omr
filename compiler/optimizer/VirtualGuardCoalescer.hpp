...
private:
    ...
    public:
        ...
        VGInfo(TR::Block* branch, TR::Block* call, TR::Block* inlined, TR::Block* merge, VGInfo* parent)
            : _branch(branch)
            , _call(call)
            , _inlined(inlined)
            , _merge(merge)
...
public:
    ...
    public:
        TR_ALLOC(TR_Memory::VirtualGuardTailSplitter)
        GuardInfo(TR::Compilation*, TR::Block* block, GuardInfo* parent, TR_ValueNumberInfo* vnInfo,
