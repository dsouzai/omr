...
public:
    ...
    void setCurrentRegisterCandidate(
        TR::RegisterCandidate* rc, vcount_t, TR::Block*, int32_t, TR::Compilation*, bool resetOtherHalfOfLong = true);
    ...
    TR::Node* createStoreFromRegister(
        vcount_t, TR::TreeTop*, int32_t, TR::Compilation*, bool storeUnconditionally = false);
