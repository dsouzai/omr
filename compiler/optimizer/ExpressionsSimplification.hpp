...
private:
    ...
    public:
         ...
         */
        SimplificationCandidateTuple(TR::TreeTop* tt, flags32_t flags)
            : _treeTop(tt)
            , _flags(flags)
        { }
         ...
         *         transformation
         */
        bool isInvariantExpressionCandidate() { return _flags.testAny(InvariantExpressionCandidate); }
         ...
         *         reduction transformation
         */
        bool isSummationReductionCandidate() { return _flags.testAny(SummationReductionCandidate); }
