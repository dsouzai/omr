...
TR::CodeCache *OMR::CodeCacheManager::initialize(bool allocateMonolithicCodeCache,
...
TR::CodeCache *OMR::CodeCacheManager::allocateCodeCacheObject(TR::CodeCacheMemorySegment *codeCacheSegment,
...
TR::CodeCache *OMR::CodeCacheManager::reserveCodeCache(bool compilationCodeAllocationsMustBeContiguous,
    size_t sizeEstimate, int32_t compThreadID, int32_t *numReserved)
{
...
void OMR::CodeCacheManager::performSizeAdjustments(size_t &warmCodeSize, size_t &coldCodeSize, bool needsToBeContiguous,
    ...
    bool isMethodHeaderNeeded)
{
    ...
    warmCodeAddress = codeCache->allocateCodeMemory(warmCodeSize, coldCodeSize, coldCode, needsToBeContiguous,
...
TR::CodeCacheMemorySegment *OMR::CodeCacheManager::getNewCodeCacheMemorySegment(size_t segmentSize,
...
TR::CodeCacheMemorySegment *OMR::CodeCacheManager::carveCodeCacheSpaceFromRepository(size_t segmentSize,
...
TR::CodeCacheMemorySegment *OMR::CodeCacheManager::setupMemorySegmentFromRepository(uint8_t *start, uint8_t *end,
    size_t &codeCacheSizeToAllocate)
{
    TR::CodeCacheMemorySegment *memorySegment
...
void OMR::CodeCacheManager::undoCarvingFromRepository(TR::CodeCacheMemorySegment *segment)
{
    ...
    TR::CodeCacheConfig &config = self()->codeCacheConfig();
    if (config.verboseCodeCache()) {
        TR_VerboseLog::writeLineLocked(TR_Vlog_CODECACHE, "undoCarving start=%p size=%lu", start,
