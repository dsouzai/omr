...
public:
    ...
    CodeCacheTrampolineCode *replaceTrampoline(TR_OpaqueMethodBlock *method, void *oldTrampoline, void *oldTargetPC,
        void *newTargetPC, bool needSync);
...
private:
    ...
    CodeCacheFreeCacheBlock *removeFreeBlock(size_t blockSize, CodeCacheFreeCacheBlock *prev,
