...
struct CodeCacheErrorCode {
    ...
    enum ErrorCode { ERRORCODE_SUCCESS = 0, ERRORCODE_INSUFFICIENTSPACE = -1, ERRORCODE_FATALERROR = -2 };
};
...
public:
    ...
    void operator delete(void* ptr, CodeCacheHashEntrySlab* slab)
    { /* do nothing */
    }
...
public:
    ...
    void operator delete(void* p, CodeCacheHashTable* table)
    { /* do nothing */
    }
