...
void TR_ARMBinaryCommutativeAnalyser::genericAnalyser(TR::Node* root, TR::InstOpCode::Mnemonic regToRegOpCode,
...
void TR_ARMBinaryCommutativeAnalyser::genericLongAnalyser(TR::Node* root, TR::InstOpCode::Mnemonic lowRegToRegOpCode,
...
void TR_ARMBinaryCommutativeAnalyser::integerAddAnalyser(TR::Node* root, TR::InstOpCode::Mnemonic regToRegOpCode)
{
    TR::Node* firstChild;
    TR::Node* secondChild;
    if (cg()->whichChildToEvaluate(root) == 0) {
