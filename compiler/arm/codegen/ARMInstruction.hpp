...
inline bool constantIsImmed8r(int32_t intValue) { return intValue < 128; }
...
public:
    ARMImmInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    { }

    ARMImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, uint32_t imm, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
        , _sourceImmediate(imm)
        , _reloKind(TR_NoRelocation)
        , _symbolReference(NULL)
    {
        setOpCodeValue(op);
    }

    ARMImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::RegisterDependencyConditions* cond, uint32_t imm,
        TR::CodeGenerator* cg)
    ...
    ARMImmInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node, uint32_t imm,
        TR::CodeGenerator* cg)
    ...
    ARMImmInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::RegisterDependencyConditions* cond, uint32_t imm, TR::CodeGenerator* cg)
        : TR::Instruction(precedingInstruction, op, node, cond, cg)
        , _sourceImmediate(imm)
        , _reloKind(TR_NoRelocation)
        , _symbolReference(NULL)
    { }

    ARMImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, uint32_t imm,
        TR_ExternalRelocationTargetKind relocationKind, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, cg)
        , _sourceImmediate(imm)
        , _reloKind(relocationKind)
        , _symbolReference(NULL)
    {
    ...
    void insertImmediateField(uint32_t* instruction) { *instruction |= _sourceImmediate & 0xffff; }
...
public:
    ...
    ARMLabelInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::RegisterDependencyConditions* cond,
    ...
    ARMLabelInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::LabelSymbol* sym, TR::CodeGenerator* cg, TR::Register* t1reg = NULL, TR::Register* s1reg = NULL)
        : TR::Instruction(precedingInstruction, op, node, cg)
        , _symbol(sym)
        , _t1reg(t1reg)
        , _s1reg(s1reg)
    ...
    void insertTargetRegister(uint32_t* instruction) { toRealRegister(_t1reg)->setRegisterFieldRD(instruction); }

    void insertSource1Register(uint32_t* instruction) { toRealRegister(_s1reg)->setRegisterFieldRN(instruction); }
...
public:
    ...
    ARMConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::LabelSymbol* sym,
        TR_ARMConditionCode cc, TR::CodeGenerator* cg)
    ...
    ARMConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::RegisterDependencyConditions* cond,
        TR::LabelSymbol* sym, TR_ARMConditionCode cc, TR::CodeGenerator* cg)
    ...
    ARMConditionalBranchInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::LabelSymbol* sym, TR_ARMConditionCode cc, TR::CodeGenerator* cg)
    ...
    ARMConditionalBranchInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::RegisterDependencyConditions* cond, TR::LabelSymbol* sym, TR_ARMConditionCode cc, TR::CodeGenerator* cg)
...
public:
    ARMVirtualGuardNOPInstruction(TR::Node* node, TR_VirtualGuardSite* site, TR::RegisterDependencyConditions* cond,
        TR::LabelSymbol* sym, TR::CodeGenerator* cg)
...
public:
    ARMAdminInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Node* fenceNode, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, cg)
        , _fenceNode(fenceNode)
    { }

    ARMAdminInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Node* fenceNode,
        TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, cond, cg)
        , _fenceNode(fenceNode)
    { }

    ARMAdminInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
    ...
    ARMAdminInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Node* fenceNode, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
        : TR::Instruction(precedingInstruction, op, node, cond, cg)
        , _fenceNode(fenceNode)
    { }
...
public:
    ARMImmSymInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::ARMImmInstruction(node, cg)
        , _symbolReference(NULL)
        , _snippet(NULL)
    { }

    ARMImmSymInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, uint32_t imm,
        TR::RegisterDependencyConditions* cond, TR::SymbolReference* sr, TR::CodeGenerator* cg, TR::Snippet* s = NULL,
        TR_ARMConditionCode cc = ARMConditionCodeAL);

    ARMImmSymInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        uint32_t imm, TR::RegisterDependencyConditions* cond, TR::SymbolReference* sr, TR::CodeGenerator* cg,
        TR::Snippet* s = NULL, TR_ARMConditionCode cc = ARMConditionCodeAL);
...
public:
    ARMTrg1Src2Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    { }
    ...
    ARMTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* s1reg,
        TR_ARMOperand2* s2op, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, cg)
        , _target1Register(treg)
        , _source1Register(s1reg)
        , _source2Operand(s2op)
    {
    ...
    ARMTrg1Src2Instruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* treg, TR::Register* s1reg, TR_ARMOperand2* s2op, TR::CodeGenerator* cg)
        : TR::Instruction(precedingInstruction, op, node, cg)
        , _target1Register(treg)
        , _source1Register(s1reg)
        , _source2Operand(s2op)
    ...
    ARMTrg1Src2Instruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* treg, TR::Register* s1reg, TR::Register* s2reg, TR::CodeGenerator* cg)
        : TR::Instruction(precedingInstruction, op, node, cg)
        , _target1Register(treg)
        , _source1Register(s1reg)
    {
    ...
    void insertTargetRegister(uint32_t* instruction, TR_Memory* m)
    {
        ...
        } else { // no target -> SBZ (should be zero)
    ...
    void insertSource2Operand(uint32_t* instruction) { getSource2Operand()->setBinaryEncoding(instruction); }
...
public:
    ARMLoadStartPCInstruction(TR::Node* node, TR::Register* treg, TR::SymbolReference* symRef, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(TR::InstOpCode::sub, node, treg,
            cg->machine()->getRealRegister(TR::RealRegister::gr15), new (cg->trHeapMemory()) TR_ARMOperand2(0xde, 24),
            cg)
        , /* The value 0xde does not mean anything. It will be replaced in the binary encoding phase. */
        _symbolReference(symRef)
    { }

    ARMLoadStartPCInstruction(TR::Instruction* precedingInstruction, TR::Node* node, TR::Register* treg,
        TR::SymbolReference* symRef, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(precedingInstruction, TR::InstOpCode::sub, node, treg,
            cg->machine()->getRealRegister(TR::RealRegister::gr15), new (cg->trHeapMemory()) TR_ARMOperand2(0xde, 0),
            cg)
        , /* The value 0xde does not mean anything. It will be replaced in the binary encoding phase. */
        _symbolReference(symRef)
    { }
...
public:
    ARMSrc2Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(node, cg)
    { }

    ARMSrc2Instruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* s1reg, TR_ARMOperand2* s2op, TR::CodeGenerator* cg)
    ...
    ARMSrc2Instruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* s1reg, TR_ARMOperand2* s2op, TR::CodeGenerator* cg)
...
public:
    ARMTrg1Src1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(node, cg)
    { }

    ARMTrg1Src1Instruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR_ARMOperand2* sop, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(op, node, cg)
    {
    ...
    ARMTrg1Src1Instruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::RegisterDependencyConditions* cond,
        TR::Register* treg, TR_ARMOperand2* sop, TR::CodeGenerator* cg)
    ...
    ARMTrg1Src1Instruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* treg, TR_ARMOperand2* sop, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(precedingInstruction, op, node, cg)
    {
        setTarget1Register(treg);
    ...
    ARMTrg1Src1Instruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(op, node, cg)
    {
        TR_ARMOperand2* sop = new (cg->trHeapMemory()) TR_ARMOperand2(ARMOp2Reg, sreg);
        setTarget1Register(treg);
...
public:
    ARMTrg1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    { }

    ARMTrg1Instruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, cg)
        , _target1Register(treg)
    {
        treg->incTotalUseCount();
    ...
    ARMTrg1Instruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* treg, TR::CodeGenerator* cg)
        : TR::Instruction(precedingInstruction, op, node, cg)
        , _target1Register(treg)
    {
        treg->incTotalUseCount();
...
public:
    ARMTrg2Src1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(node, cg)
        , _target2Register(0)
    { }

    ARMTrg2Src1Instruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* t1reg, TR::Register* t2reg,
        TR::Register* sreg, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(op, node, cg)
        , _target2Register(t2reg)
    {
    ...
    ARMTrg2Src1Instruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* t1reg, TR::Register* t2reg, TR::Register* sreg, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(precedingInstruction, op, node, cg)
        , _target2Register(t2reg)
    {
        setTarget1Register(t1reg);
...
public:
    ARMMulInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    { }

    ARMMulInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, cg)
        , _targetLoRegister(0)
        , _targetHiRegister(0)
        , _source1Register(0)
    ...
    ARMMulInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* tregLo, TR::Register* s1reg,
        TR::Register* s2reg, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, cg)
    ...
    ARMMulInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* tregLo, TR::Register* s1reg, TR::Register* s2reg, TR::CodeGenerator* cg)
        : TR::Instruction(precedingInstruction, op, node, cg)
        , _targetLoRegister(tregLo)
        , _targetHiRegister(0)
        , _source1Register(s1reg)
    ...
    ARMMulInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* tregHi, TR::Register* tregLo,
        TR::Register* s1reg, TR::Register* s2reg, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, cg)
        , _targetLoRegister(tregLo)
    ...
    ARMMulInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* tregHi, TR::Register* tregLo, TR::Register* s1reg, TR::Register* s2reg, TR::CodeGenerator* cg)
        : TR::Instruction(precedingInstruction, op, node, cg)
        , _targetLoRegister(tregLo)
        , _targetHiRegister(tregHi)
        , _source1Register(s1reg)
...
public:
    ARMMemInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::ARMTrg1Instruction(node, cg)
    { }

    ARMMemInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::MemoryReference* mf,
        bool memRead, TR::CodeGenerator* cg)
        : TR::ARMTrg1Instruction(op, node, treg, cg)
        , _memoryReference(mf)
        , _memoryRead(memRead)
    {
    ...
    ARMMemInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* treg, TR::MemoryReference* mf, bool memRead, TR::CodeGenerator* cg)
        : TR::ARMTrg1Instruction(precedingInstruction, op, node, treg, cg)
        , _memoryReference(mf)
        , _memoryRead(memRead)
    {
        mf->incRegisterTotalUseCounts(cg);
...
public:
    ARMMemSrc1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::ARMMemInstruction(node, cg)
    { }

    ARMMemSrc1Instruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::MemoryReference* mf, TR::Register* sreg, TR::CodeGenerator* cg)
        : TR::ARMMemInstruction(op, node, sreg, mf, true, cg)
    { }

    ARMMemSrc1Instruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::MemoryReference* mf, TR::Register* sreg, TR::CodeGenerator* cg)
...
public:
    ARMTrg1MemInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::ARMMemInstruction(node, cg)
    { }

    ARMTrg1MemInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* sreg, TR::MemoryReference* mf, TR::CodeGenerator* cg)
        : TR::ARMMemInstruction(op, node, sreg, mf, false, cg)
    { }

    ARMTrg1MemInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* sreg, TR::MemoryReference* mf, TR::CodeGenerator* cg)
...
public:
    ARMTrg1MemSrc1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::ARMMemInstruction(node, cg)
    { }

    ARMTrg1MemSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::MemoryReference* mf,
        TR::Register* sreg, TR::CodeGenerator* cg)
        : TR::ARMMemInstruction(op, node, treg, mf, false, cg)
        , _source1Register(sreg)
    { }

    ARMTrg1MemSrc1Instruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* treg, TR::MemoryReference* mf, TR::Register* sreg, TR::CodeGenerator* cg)
        : TR::ARMMemInstruction(precedingInstruction, op, node, treg, mf, false, cg)
        , _source1Register(sreg)
    { }
...
public:
    ARMControlFlowInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    { }
    ARMControlFlowInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::CodeGenerator* cg)
        ...
        , _numTargets(0)
        , _label(NULL)
        , _opCode2(TR::InstOpCode::bad)
    { }

    ARMControlFlowInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::RegisterDependencyConditions* deps, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, deps, cg)
        , _numSources(0)
        , _numTargets(0)
        , _label(NULL)
        , _opCode2(TR::InstOpCode::bad)
    ...
    TR::Register* setSourceRegister(int32_t i, TR::Register* sr) { return (_sourceRegisters[i] = sr); }
...
public:
    ...
    ARMMultipleMoveInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* mbr, uint16_t rl, TR::CodeGenerator* cg)
        : TR::Instruction(op, node, cg)
        , _memoryBaseRegister(mbr)
        , _registerList(rl)
        , _writeBack(false)
        , _increment(false)
        , _preIndex(false)
    ...
    ARMMultipleMoveInstruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op, TR::Node* node,
        TR::Register* mbr, uint16_t rl, TR::CodeGenerator* cg)
        : TR::Instruction(precedingInstruction, op, node, cg)
        , _memoryBaseRegister(mbr)
        , _registerList(rl)
        , _writeBack(false)
    ...
    void insertRegisterList(uint32_t* instruction) { *instruction |= (uint32_t)getRegisterList(); }
