    ...
    TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    cg->addExternalRelocation(
        TR::ExternalRelocation::create(cursor, (uint8_t*)symRef, TR_HelperAddress, cg), __FILE__, __LINE__, node);
                    ...
                    *(int32_t*)cursor = imm;
                    ...
                    if (sym->isNative()
                        ...
                        *(int32_t*)cursor = imm;
                        ...
                        TR_ASSERT_FATAL(cg()->comp()->target().cpu.isTargetWithinBranchImmediateRange(
                                            targetAddress, (intptr_t)cursor),
                            "Target address is out of range");
