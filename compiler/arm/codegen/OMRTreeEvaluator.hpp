...
public:
    ...
    static TR::Register *commonLoadEvaluator(TR::Node *node, TR::InstOpCode::Mnemonic memoryToRegisterOp,
        int32_t memSize, TR::CodeGenerator *cg);
    static TR::Register *commonStoreEvaluator(TR::Node *node, TR::InstOpCode::Mnemonic memToRegOp, int32_t memSize,
        TR::CodeGenerator *cg);
    ...
    static TR::Instruction *generateVFTMaskInstruction(TR::CodeGenerator *cg, TR::Node *node, TR::Register *dstReg,
        TR::Register *srcReg, TR::Instruction *prev = 0);
    ...
    static TR::Instruction *compareIntsForEquality(TR_ARMConditionCode branchType, TR::Node *node,
        TR::CodeGenerator *cg, TR::SymbolReference *sr = NULL);
