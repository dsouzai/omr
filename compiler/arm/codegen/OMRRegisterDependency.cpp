...
OMR::ARM::RegisterDependencyConditions::RegisterDependencyConditions(
    uint8_t numPreConds, uint8_t numPostConds, TR_Memory* m)
...
OMR::ARM::RegisterDependencyConditions::RegisterDependencyConditions(
    TR::Node* node, uint32_t extranum, TR::Instruction** cursorPtr, TR::CodeGenerator* cg)
{
...
void OMR::ARM::RegisterDependencyConditions::addPreCondition(
    TR::Register* vr, TR::RealRegister::RegNum rr, uint8_t flag)
{
    _preConditions->setDependencyInfo(_addCursorForPre++, vr, rr, flag);
}

void OMR::ARM::RegisterDependencyConditions::addPostCondition(
    TR::Register* vr, TR::RealRegister::RegNum rr, uint8_t flag)
{
    _postConditions->setDependencyInfo(_addCursorForPost++, vr, rr, flag);
}

void OMR::ARM::RegisterDependencyConditions::assignPreConditionRegisters(
...
void OMR::ARM::RegisterDependencyConditions::assignPostConditionRegisters(
    TR::Instruction* currentInstruction, TR_RegisterKinds kindToBeAssigned, TR::CodeGenerator* cg)
{
