...
TR::Instruction* OMR::ARM::CodeGenerator::generateSwitchToInterpreterPrePrologue(
...
#if 1
TR_GlobalRegisterNumber OMR::ARM::CodeGenerator::getLinkageGlobalRegisterNumber(
