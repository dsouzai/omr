...
typedef OMR::ARM::MemoryReference MemoryReferenceConnector;
} // namespace OMR
#else
...
public:
    ...
    bool isBaseModifiable() { return (_flag & TR_ARMMemoryReferenceControl_Base_Modifiable) != 0; }
    ...
    bool isIndexModifiable() { return (_flag & TR_ARMMemoryReferenceControl_Index_Modifiable) != 0; }
    ...
    bool isImmediatePreIndexed() { return (_flag & TR_ARMMemoryReferenceControl_Immediate_Pre_Indexed) != 0; }
    ...
    bool isPostIndexed() { return (_flag & TR_ARMMemoryReferenceControl_Post_Indexed) != 0; }
    ...
    TR::ARMPairedRelocation* setStaticRelocation(TR::ARMPairedRelocation* r) { return (_staticRelocation = r); }

    bool refsRegister(TR::Register* reg)
    {
        if (reg == _baseRegister || reg == _indexRegister || reg == _modBase) {
            return true;
        }
        return false;
    }
    ...
    uint8_t* encodeLargeARMConstant(
