...
TR::Instruction* generateInstruction(
    TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateAdminInstruction(
    TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Node* fenceNode, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateAdminInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::RegisterDependencyConditions* cond, TR::Node* fenceNode, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateImmInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    uint32_t imm, TR::RegisterDependencyConditions* cond, TR::Instruction* prev)
...
TR::Instruction* generateImmInstruction(
    TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node, uint32_t imm, TR::Instruction* prev)
...
TR::Instruction* generateImmInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    uint32_t imm, TR_ExternalRelocationTargetKind relocationKind, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateImmInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    uint32_t imm, TR_ExternalRelocationTargetKind relocationKind, TR::SymbolReference* sr, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateImmSymInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    uint32_t imm, TR::RegisterDependencyConditions* cond, TR::SymbolReference* sr, TR::Snippet* s,
    TR::Instruction* prev, TR_ARMConditionCode cc)
{
    if (prev)
...
TR::Instruction* generateMemSrc1Instruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::MemoryReference* mf, TR::Register* sreg, TR::Instruction* prev)
{
...
TR::Instruction* generateTrg1MemInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* treg, TR::MemoryReference* mf, TR::Instruction* prev)
{
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
    TR::InstOpCode opCode(op);
    if (opCode.isVFPOp()) {
...
TR::Instruction* generateTrg1MemSrc1Instruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* treg, TR::MemoryReference* mf, TR::Register* sreg, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateTrg1ImmInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* treg, uint32_t base, uint32_t rotate, TR::Instruction* prev)
{
...
TR::Instruction* generateSrc1ImmInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* s1reg, uint32_t base, uint32_t rotate, TR::Instruction* prev)
{
    TR::InstOpCode opCode(op);
    TR_ARMOperand2* operand = new (cg->trHeapMemory()) TR_ARMOperand2(base, rotate);
    if (opCode.isVFPOp()) {
...
TR::Instruction* generateSrc2Instruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* s1reg, TR::Register* s2reg, TR::Instruction* prev)
{
    TR::InstOpCode opCode(op);
...
TR::Instruction* generateTrg1Src1Instruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* treg, TR_ARMOperand2* s1op, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateTrg1Src1Instruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* treg, TR::Register* s1reg, TR::Instruction* prev)
{
    if (op == TR::InstOpCode::fmrs || op == TR::InstOpCode::fmsr) {
        TR_ARMOperand2* operand = new (cg->trHeapMemory()) TR_ARMOperand2(0, 0);
        if (prev)
            return new (cg->trHeapMemory()) TR::ARMTrg1Src2Instruction(prev, op, node,
                (op == TR::InstOpCode::fmrs) ? treg : s1reg, (op == TR::InstOpCode::fmrs) ? s1reg : treg, operand, cg);
        else
            return new (cg->trHeapMemory()) TR::ARMTrg1Src2Instruction(op, node,
                (op == TR::InstOpCode::fmrs) ? treg : s1reg, (op == TR::InstOpCode::fmrs) ? s1reg : treg, operand, cg);
    } else {
...
TR::Instruction* generateTrg1Src1ImmInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* treg, TR::Register* s1reg, uint32_t base, uint32_t rotate, TR::Instruction* prev)
{
    TR_ARMOperand2* operand = new (cg->trHeapMemory()) TR_ARMOperand2(base, rotate);
    if (prev)
...
TR::Instruction* generateTrg1Src2Instruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* treg, TR::Register* s1reg, TR_ARMOperand2* s2op, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateTrg1Src2Instruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* treg, TR::Register* s1reg, TR::Register* s2reg, TR::Instruction* prev)
{
...
TR::Instruction* generateTrg2Src1Instruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* t1reg, TR::Register* t2reg, TR::Register* sreg, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateTrg2Src2MulInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::Register* tregHi, TR::Register* tregLo, TR::Register* s1reg, TR::Register* s2reg, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateShiftLeftImmediate(TR::CodeGenerator* cg, TR_ARMOperand2Type type, TR::Node* node,
    TR::Register* trgReg, TR::Register* srcReg, int32_t shiftAmount, TR::Instruction* prev)
{
...
TR::Instruction* generateShiftLeftByRegister(TR::CodeGenerator* cg, TR::Node* node, TR::Register* trgReg,
    TR::Register* srcReg, TR::Register* shiftRegister, TR::Instruction* prev)
{
...
TR::Instruction* generateShiftRightImmediate(TR::CodeGenerator* cg, TR::Node* node, TR::Register* trgReg,
    TR::Register* srcReg, int32_t shiftAmount, bool isLogical, TR::Instruction* prev)
{
...
TR::Instruction* generateShiftRightByRegister(TR::CodeGenerator* cg, TR::Node* node, TR::Register* trgReg,
    TR::Register* srcReg, TR::Register* shiftRegister, bool isLogical, TR::Instruction* prev)
{
...
TR::Instruction* generateLabelInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::LabelSymbol* sym, TR::Instruction* prev, TR::Register* trgReg, TR::Register* src1Reg)
{
    if (prev)
...
TR::Instruction* generateLabelInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* node,
    TR::LabelSymbol* sym, TR::RegisterDependencyConditions* cond, TR::Instruction* prev)
{
    if (prev)
...
TR::Instruction* generateConditionalBranchInstruction(
    TR::CodeGenerator* cg, TR::Node* node, TR_ARMConditionCode cc, TR::LabelSymbol* sym, TR::Instruction* prev)
{
    if (prev)
    ...
    TR::LabelSymbol* sym, TR::RegisterDependencyConditions* cond, TR::Instruction* prev)
{
    if (prev)
        return new (cg->trHeapMemory())
            TR::ARMConditionalBranchInstruction(prev, TR::InstOpCode::b, node, cond, sym, cc, cg);
    else
...
TR::Instruction* generatePreIncLoadInstruction(TR::CodeGenerator* cg, TR::Node* node, TR::Register* treg,
    TR::Register* baseReg, uint32_t offset, TR::Instruction* prev)
{
