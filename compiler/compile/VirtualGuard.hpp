...
public:
    ...
    static TR::Node* createVftGuard(
        TR_VirtualGuardKind, TR::Compilation*, int16_t calleeIndex, TR::Node*, TR::TreeTop*, TR_OpaqueClassBlock*);
    ...
    static TR_VirtualGuard* createGuardedDevirtualizationGuard(
        TR_VirtualGuardKind, TR::Compilation*, TR::Node* callNode);
