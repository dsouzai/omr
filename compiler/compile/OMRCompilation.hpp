...
public:
    ...
    bool incInlineDepth(TR::ResolvedMethodSymbol *, TR::Node *callNode, bool directCall,
        TR_VirtualGuardSelection *guard, TR_OpaqueClassBlock *receiverClass, TR_PrexArgInfo *argInfo = 0);
...
public:
    ...
    void getOSRCallSiteRemat(uint32_t callSiteIndex, uint32_t slot, TR::SymbolReference *&ppSymRef,
    ...
    int32_t convertNonDeterministicInput(int32_t i, int32_t max, TR_RandomGenerator *randomGen = 0, int32_t min = 0,
        bool emitVerbose = true);
