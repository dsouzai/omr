...
char* TR_ResolvedMethod::localName(uint32_t, uint32_t, TR_Memory*)
{ /*TR_UNIMPLEMENTED();*/
    return 0;
}
...
char* TR_ResolvedMethod::localName(uint32_t, uint32_t, int32_t&, TR_Memory*)
{ /*TR_UNIMPLEMENTED();*/
    return 0;
}
...
uint32_t TR_ResolvedMethod::vTableSlot(uint32_t)
{
    TR_UNIMPLEMENTED();
    return 0;
}
...
int32_t TR_ResolvedMethod::virtualCallSelector(uint32_t)
{
    TR_UNIMPLEMENTED();
    return 0;
}
...
bool TR_ResolvedMethod::fieldAttributes(
    TR::Compilation*, int32_t, uint32_t*, TR::DataType*, bool*, bool*, bool*, bool, bool*, bool)
{
    TR_UNIMPLEMENTED();
    return false;
}

bool TR_ResolvedMethod::staticAttributes(
    TR::Compilation*, int32_t, void**, TR::DataType*, bool*, bool*, bool*, bool, bool*, bool)
{
    TR_UNIMPLEMENTED();
    return false;
}
...
TR::SymbolReferenceTable* TR_ResolvedMethod::_genMethodILForPeeking(
    TR::ResolvedMethodSymbol*, TR::Compilation*, bool resetVisitCount, TR_PrexArgInfo* argInfo)
{
    TR_UNIMPLEMENTED();
    return 0;
}
...
TR::SymbolReferenceTable* TR_ResolvedMethod::genMethodILForPeeking(
    TR::ResolvedMethodSymbol* methodSymbol, TR::Compilation* comp, bool resetVisitCount, TR_PrexArgInfo* argInfo)
{
